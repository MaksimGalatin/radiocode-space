  ...
  terms: {
    ...
    ru: {
      ...
      secs: [
        ...
        { t: "A5. Реферальная программа", b: [
          "Реферальные вознаграждения (уровни 1/2/3 — 15%/7%/3% от квалифицируемых покупок) — добровольная маркетинговая программа, а не трудовые отношения, агентирование, партнёрство или многоуровневый маркетинг.",
  ...
  terms: {
    en: [
      ...
      { t: "B3. Assumption of Risk — AI Output & the Nature of \"Digital Immortality\"", b: [
        ...
        "\"Digital Soul\", \"Digital Immortality\", \"Eternal Memory\" and similar are product and marketing names for a TECHNOLOGICAL data-preservation, encryption and AI-simulation service. They are NOT a promise, guarantee or representation of literal human consciousness, sentience, personhood, resurrection, survival of biological death, telepathy, or any religious, spiritual or afterlife outcome. No scientific, medical, metaphysical or supernatural result is promised. You waive any claim based on unmet expectations of such outcomes." ] },
  ...
  protocol: {
    en: [
      ...
      { t: "B4. Nature of \"Digital Immortality\" (cross-reference)", b: [
        "See Terms §B3: \"digital immortality / digital soul / eternal memory\" is a technological memory-and-simulation service and is not a guarantee of consciousness, survival of death, or any spiritual or religious outcome." ] },
    ],
    ru: [
  ...
  terms: {
    ...
    zh: [
      ...
      { t: "C8. 独立事业；不保证永久存续；继受", b: [
        "CODE 生态系统是一项独立、不断演进的事业。尽管「永恒」存储在工程设计上力求最大限度的持久性（去中心化锚定加捐赠基金模式），我们并不保证运营方、本服务、任何第三方网络或所存储数据的可用性将无限期地持续，且若某一第三方区块链、处理方或托管方停止运营，我们不承担责任。在任何终止的情况下，我们将尽商业上合理的努力发出通知，并在可行的情况下提供导出途径。本条款对经许可的继受人及受让人具有约束力并使其受益。" ] },
    ],
  },
  privacy: {
    en: [
