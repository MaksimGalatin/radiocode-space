        ...
        <section id="benchmarks" className="space-y-12">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="bg-white dark:bg-[#0B0F19] border border-slate-200 dark:border-[#1E293B] rounded-3xl p-6 sm:p-8 space-y-6 shadow-2xl relative overflow-hidden">
              ...
              <div className="pt-3 border-t border-slate-200 dark:border-gray-800/80 text-xs font-mono text-amber-700 dark:text-amber-400">
          ...
          <div className="bg-white dark:bg-[#0B0F19] border border-[#1E293B] rounded-3xl p-6 sm:p-8 shadow-2xl relative overflow-hidden">
            ...
            <p className="text-[11px] font-mono text-amber-700 dark:text-amber-400 mt-2 font-semibold">
              {JX[lang].duel}
            </p>
            ...
            <div className="bg-white dark:bg-[#0B0F19] border border-[#1E293B] rounded-3xl p-6 sm:p-8 space-y-6 shadow-2xl">
              ...
              <div className="grid grid-cols-2 gap-4 pt-2">
                <div className="p-4 rounded-2xl bg-slate-50 dark:bg-black/40 border border-slate-200 dark:border-gray-800 space-y-1">
                  ...
                  <div className="text-2xl sm:text-3xl font-black text-amber-700 dark:text-amber-500 font-mono">39.55%</div>
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
              ...
              <div className="flex flex-wrap items-center gap-3">
                ...
                <button
                  ...
                  className="px-4 py-2 rounded-xl bg-slate-100 dark:bg-black/60 hover:bg-slate-200 dark:hover:bg-gray-800 text-slate-800 dark:text-slate-200 font-semibold text-xs font-mono transition-all flex items-center gap-2 border border-slate-300 dark:border-gray-700"
                >
            ...
            <div className="bg-white dark:bg-black/60 border border-slate-200 dark:border-[#00F0FF]/30 rounded-3xl p-6 space-y-4 text-left my-6 font-mono text-xs shadow-xl">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-1 text-[11px]">
                <div className="p-3 rounded-xl bg-slate-50 dark:bg-black/40 border border-slate-200 dark:border-gray-800">
                  ...
                  <span className="text-emerald-800 dark:text-emerald-400 font-bold block mt-0.5">{VB[lang].repRes}</span>
                </div>
                <div className="p-3 rounded-xl bg-slate-50 dark:bg-black/40 border border-slate-200 dark:border-gray-800">
          ...
          <div className="mt-12 p-6 sm:p-8 rounded-3xl bg-white dark:bg-[#0B0F19] border border-slate-200 dark:border-cyan-500/40 shadow-2xl space-y-6">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3 font-mono text-xs">
              ...
              <div className="p-3 rounded-xl bg-slate-50 dark:bg-black/40 border border-slate-200 dark:border-purple-800/60 space-y-1">
                ...
                <p className="text-[10px] text-slate-500 dark:text-gray-400">{lang === 'ru' ? 'Промышленный кластер' : lang === 'es' ? 'Clúster de producción' : lang === 'zh' ? '生产集群' : 'Production cluster'}</p>
              </div>
            </div>
              ...
              <button
                ...
                className={`px-4 py-1.5 rounded-xl text-xs font-mono font-semibold transition-all ${
                  techFilter === 'prod'
                    ...
                    : 'bg-white dark:bg-[#0B0F19] text-green-700 dark:text-green-400 hover:text-slate-900 dark:text-white border border-green-300 dark:border-green-900/60'
                }`}
              >
                {t.filterTechProd}
              </button>
              <button
                ...
                className={`px-4 py-1.5 rounded-xl text-xs font-mono font-semibold transition-all ${
                  techFilter === 'rnd'
                    ...
                    : 'bg-white dark:bg-[#0B0F19] text-amber-700 dark:text-yellow-400 hover:text-slate-900 dark:text-white border border-amber-300 dark:border-yellow-900/60'
                }`}
              >
                {t.filterTechRnd}
              </button>
