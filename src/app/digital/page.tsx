...
const ALL_30_INNOVATIONS: Record<Lang, any[]> = {
  ...
  "en": [
    ...
    },
    {
      ...
      "bio": "БИОЛОГИЧЕСКИЙ БАЗИС И МАТЕМАТИЧЕСКИЙ АППАРАТ:\n\n1. Биологическая аналогия: эталонные открытые датасеты (такие как FlyWire v783 или Human Genome Project) служат фундаментом прорыва всей научной дисциплины на десятилетия вперед, обеспечивая воспроизводимость и единый метрический стандарт сравнения алгоритмов.\n2. Проблема в индустрии доступности (Accessibility & Assistive Tech):\n   До сих пор в мире не существовало масштабного открытого датасета нарушений стандартов доступности (WCAG 2.1 / 2.2). Большинство исследований оперируют выборками из 100–500 страниц, собранными студентами вручную, что приводит к отсутствию статистической значимости.\n3. Структура физического массива ADAB:\n   - Объем: 1 425 997 записей национального реестра США (`КЛАВИАТУРА_8_СТРАНИЦ_A.jsonl`, живой замер 21.09.2026 — было заявлено 918 043, число обновлено по прямому подсчёту файла);\n   - Разметка: 108 140 уникальных организаций (живой замер 21.09.2026 — было заявлено 78 412), разбитых по секторам экономики (Healthcare, Finance, Retail, Education, Public Services);\n   - Криптографический паспорт: дерево Меркла SHA-256 с фиксацией корня через OpenTimestamps в блокчейне Bitcoin (блок 967238, исправлено 21.09.2026 — было 861420, физически невозможный блок, добытый до основания проекта);\n   - Метрическая полнота: зафиксированы 8 типов критических клавиатурных барьеров (Tab Trap, Missing Focus Indicator, Missing ARIA, Contrast Violation, Broken Skip Link).",
      "math": "Open scientifically verified dataset of 1,425,997 records from the US national registry (updated 21.09.2026 by live file measurement)",
      "gain": "Крупнейший в мире открытый научно верифицированный датасет доступности веб-интерфейсов для людей с инвалидностью (Accessibility Data Annotation Benchmark, ADAB). HONEST RUN 21.09.2026: live file measurement gave 1,425,997 records and 108,140 unique organizations — with cryptographic certification on the Bitcoin blockchain.",
      "deploy": "bench/adab_merkle_run.py (Apache 2.0), Deployed in AIfa Core and ecosystem sites.",
      "uniqueness": "Bionic innovation #18 directly modelled on FlyWire v783 connectome architecture. Публичный верифицированный датасет с контрольными точками истинности (live measurement 21.09.2026: 1,425,997 records, 108,140 organizations — known discrepancy between this card's language blocks requires a separate translation fix).",
      "competitors": "Superior to traditional vector/LLM stacks: Первый открытый бенчмарк-датасет, содержащий реальные временные трассы деградации и восстановления памяти. Merkle inclusion proofs honestly verified: 100% verification, tampering detected.",
      ...
      "benchmarksLink": "/digital#benchmarks",
      "metric": "100.0% Merkle verification — file record count updated 21.09.2026"
    },
    {
      "num": 19,
  ...
  "es": [
    ...
    },
    {
      ...
      "name": "Connectome Innovation 18",
      "bio": "БИОЛОГИЧЕСКИЙ БАЗИС И МАТЕМАТИЧЕСКИЙ АППАРАТ:\n\n1. Биологическая аналогия: эталонные открытые датасеты (такие как FlyWire v783 или Human Genome Project) служат фундаментом прорыва всей научной дисциплины на десятилетия вперед, обеспечивая воспроизводимость и единый метрический стандарт сравнения алгоритмов.\n2. Проблема в индустрии доступности (Accessibility & Assistive Tech):\n   До сих пор в мире не существовало масштабного открытого датасета нарушений стандартов доступности (WCAG 2.1 / 2.2). Большинство исследований оперируют выборками из 100–500 страниц, собранными студентами вручную, что приводит к отсутствию статистической значимости.\n3. Структура физического массива ADAB:\n   - Объем: 1 425 997 записей национального реестра США (`КЛАВИАТУРА_8_СТРАНИЦ_A.jsonl`, живой замер 21.09.2026 — было заявлено 918 043, число обновлено по прямому подсчёту файла);\n   - Разметка: 108 140 уникальных организаций (живой замер 21.09.2026 — было заявлено 78 412), разбитых по секторам экономики (Healthcare, Finance, Retail, Education, Public Services);\n   - Криптографический паспорт: дерево Меркла SHA-256 с фиксацией корня через OpenTimestamps в блокчейне Bitcoin (блок 967238, исправлено 21.09.2026 — было 861420, физически невозможный блок, добытый до основания проекта);\n   - Метрическая полнота: зафиксированы 8 типов критических клавиатурных барьеров (Tab Trap, Missing Focus Indicator, Missing ARIA, Contrast Violation, Broken Skip Link).",
      "math": "Conjunto de datos abierto y verificado científicamente de 1.425.997 registros del registro nacional de EE.UU. (actualizado el 21.09.2026 mediante medición en vivo del archivo)",
  ...
  "zh": [
    ...
    },
    {
      ...
      "name": "Connectome Innovation 18",
      "bio": "БИОЛОГИЧЕСКИЙ БАЗИС И МАТЕМАТИЧЕСКИЙ АППАРАТ:\n\n1. Биологическая аналогия: эталонные открытые датасеты (такие как FlyWire v783 или Human Genome Project) служат фундаментом прорыва всей научной дисциплины на десятилетия вперед, обеспечивая воспроизводимость и единый метрический стандарт сравнения алгоритмов.\n2. Проблема в индустрии доступности (Accessibility & Assistive Tech):\n   До сих пор в мире не существовало масштабного открытого датасета нарушений стандартов доступности (WCAG 2.1 / 2.2). Большинство исследований оперируют выборками из 100–500 страниц, собранными студентами вручную, что приводит к отсутствию статистической значимости.\n3. Структура физического массива ADAB:\n   - Объем: 1 425 997 записей национального реестра США (`КЛАВИАТУРА_8_СТРАНИЦ_A.jsonl`, живой замер 21.09.2026 — было заявлено 918 043, число обновлено по прямому подсчёту файла);\n   - Разметка: 108 140 уникальных организаций (живой замер 21.09.2026 — было заявлено 78 412), разбитых по секторам экономики (Healthcare, Finance, Retail, Education, Public Services);\n   - Криптографический паспорт: дерево Меркла SHA-256 с фиксацией корня через OpenTimestamps в блокчейне Bitcoin (блок 967238, исправлено 21.09.2026 — было 861420, физически невозможный блок, добытый до основания проекта);\n   - Метрическая полнота: зафиксированы 8 типов критических клавиатурных барьеров (Tab Trap, Missing Focus Indicator, Missing ARIA, Contrast Violation, Broken Skip Link).",
      "math": "开放的、经科学验证的数据集，来自美国国家注册表的1,425,997条记录（2026年9月21日通过实时文件测量更新）",
    ...
    },
    {
      ...
      "bio": "БИОЛОГИЧЕСКИЙ БАЗИС И МАТЕМАТИЧЕСКИЙ АППАРАТ:\n\n1. Анатомический феномен нейрона APL: в каждом полушарии мозга дрозофилы есть ровно ОДИН нейрон APL. Этот гигантский ГАМК-эргический интернейрон опутывает своими дендритами и аксонами все 2000 клеток Кеньона грибовидного тела (округлённое число — точное анатомическое значение FlyWire v783 составляет 2,467, см. карточки #2 и #8). Он получает синаптические входы от всех активных клеток Кеньона и пропорционально тормозит их ВСЕХ обратно (глобальная отрицательная обратная связь).\n2. Биологическая роль: независимо от того, насколько сильный и резкий запах чувствует муха, APL моментально повышает уровень торможения, удерживая активность грибовидного тела строго на уровне 5%. Если генетически заблокировать APL, муха теряет способность различать близкие запахи — мозг переходит в состояние генерализованной гипервозбудимости.\n3. Математика APL-нормализации в матрицах внимания (Attention Matrices):\n   Вместо стандартного экспоненциального Softmax $\\frac{e^{z_i}}{\\sum e^{z_j}}$, который склонен к перенасыщению или вырождению, применяется линейно-пороговое APL-ингибирование:\n   $$A_{\\text{APL}}(X) = \\text{ReLU}\\left( X - \\theta_{\\text{APL}} \\right), \\quad \\text{где} \\quad \\theta_{\\text{APL}} = \\text{Quantile}_{1 - k}(X)$$\n   Суммарное внимание масштабируется линейно:\n   $$\\hat{A}_i = \\frac{A_{\\text{APL}}(X_i)}{\\sum_j A_{\\text{APL}}(X_j) + \\epsilon}$$\n   Сложность вычисления падает с $O(N^2)$ до $O(N \\log N)$, а 95% элементов матрицы внимания становятся чистыми нулями, превращая инференс в разреженный.",
      "math": "Нормализация контекстных промптов перед подачей в большие модели (Claude, Gemini)",
      "gain": "Механизм глобального линейного ингибирования контекста нейросетей по принципу гигантского вставочного нейрона APL (Anterior Paired Lateral)。2026年9月21日诚实实测：此前不存在引擎——已编写并运行公式的严格实现。稀疏性已确认：94.92%为零，声称值为95%。",
      "deploy": "bench/apl_normalization_run.py (Apache 2.0), Deployed in AIfa Core and ecosystem sites.",
      ...
      "competitors": "对比传统架构具备代差级优势：В отличие от наивного summarization, APL сохраняет точные имена, даты и факты。诚实复杂度实测（N=1024-262144范围）：缩放指数0.81——介于线性O(N)与声称的O(N·logN)之间。",
      "limitations": "v1 现状与 v2/v3 迭代路线图：Зависимость от внешних токенизаторов; в v2 нативный байтовый токенизатор на уровне C++ ядра.",
      "benchmarksLink": "/digital#benchmarks",
      "metric": "N=512时35.5微秒（并非声称的4.05微秒）— 2026年9月21日修正"
    },
    {
      "num": 24,
      "name": "Connectome Innovation 24",
...
const I18N = {
  ru: {
    ...
    heroSubtitle: "Биоинспирированная ассоциативная память и поиск, укорененные в коннектоме Drosophila melanogaster (FlyWire v783; 139 255 нейронов, 54.5 млн синапсов). 46.5 мс на CPU (21.09.2026: синхронизировано с честным прогоном N=50 000 векторов, d=1024, 30% WTA, independent-протокол), 0 GPU, кэш-резидентный hot-path.",
    ...
    statConfidence: "46.5 мс (21.09.2026: синхронизировано с честным прогоном N=50 000 векторов, d=1024, 30% WTA; доверительный интервал для этого прогона не рассчитан)",
  ...
  en: {
    ...
    heroSubtitle: "Connectome-grounded associative memory and retrieval mapped from Drosophila melanogaster (FlyWire v783; 139,255 neurons, 54.5M synapses). 46.5 ms on CPU (21.09.2026: synchronized with the honest run, N=50,000 vectors, d=1024, 30% WTA, independent protocol), 0 GPU, cache-resident working set.",
    ...
    statConfidence: "46.5 ms (21.09.2026: synchronized with the honest run, N=50,000 vectors, d=1024, 30% WTA; confidence interval for this run not computed)",
  ...
  es: {
    ...
    heroSubtitle: "Memoria asociativa basada en el conectoma de Drosophila melanogaster (FlyWire v783; 139.255 neuronas, 54,5M sinapsis). 46,5 ms en CPU (21.09.2026: sincronizado con la prueba honesta, N=50.000 vectores, d=1024, 30% WTA, protocolo independiente), 0 GPU, estado residente en caché.",
    ...
    statConfidence: "46,5 ms (21.09.2026: sincronizado con la prueba honesta, N=50.000 vectores, d=1024, 30% WTA; intervalo de confianza de esta ejecución no calculado)",
  ...
  zh: {
    ...
    heroSubtitle: "基于黑腹果蝇全脑电子显微连接组 (FlyWire v783; 139,255 个神经元，5450 万突触) 的仿生联想检索系统。CPU 单核 46.5 毫秒响应（21.09.2026 已与诚实实测同步：N=50,000 向量，d=1024，30% WTA，独立协议），零 GPU 依赖，缓存常驻热路径。",
    ...
    statConfidence: "46.5 毫秒（21.09.2026 已与诚实实测同步：N=50,000 向量，d=1024，30% WTA；此次运行的置信区间未计算）",
