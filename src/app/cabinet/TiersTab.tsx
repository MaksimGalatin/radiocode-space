...
const BENEFITS: Record<number, [string, string, string, string][]> = {
  1: [
    ...
    ["Амбассадорский доход: 15% с первого уровня, 7% со второго, 3% с третьего",
     "Ambassador income: 15% level 1, 7% level 2, 3% level 3",
     "Ingresos de embajador: 15% nivel 1, 7% nivel 2, 3% nivel 3",
     "大使收益：一级 15%，二级 7%，三级 3%"],
