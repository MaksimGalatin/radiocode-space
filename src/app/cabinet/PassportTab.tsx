        ...
        <div className="cab-pass" onClick={() => setFlipped(f => !f)} role="button" tabIndex={0}
          ...
          {!flipped ? (
            <div style={{ position: "relative", zIndex: 1 }}>
              ...
              {manifesto && <div style={{ fontSize: 15, color: TOKENS.sub, marginTop: 12, fontStyle: "italic", lineHeight: 1.5 }}>&ldquo;{manifesto.slice(0, 140)}{manifesto.length > 140 ? "…" : ""}&rdquo;</div>}
