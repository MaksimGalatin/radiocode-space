    ...
    sections: [
      ...
      },
      {
        ...
        subsections: [
          {
            subtitle: "2.1 服务类别",
            text: "承包方全部或部分提供以下服务：\n\n• 网站创建与开发（落地页、企业网站、Web 应用）；\n• 整改由 Oracle 扫描识别的违规与缺陷（无障碍/ADA/WCAG、隐私/CCPA、追踪/HIPAA、邮件/DMARC 及类似技术风险）；\n• 将 AI 智能体与助手（AIfa 及第三方模型）集成到客户的产品与流程中；\n• 网页设计、UX/UI、品牌及相关创意服务。\n\n任何项目的确切范围仅由相应工作说明书确定。工作说明书未明确列出的一切均不在范围之内。",
          },
          {
            subtitle: "2.2 整改服务的性质与界限",
            text: "合规整改服务是旨在降低可识别技术风险的技术服务。它并非法律咨询、法律代理、法律审计，也不是对任何法律、标准或法规（包括 ADA、WCAG、CCPA/CPRA、HIPAA、GDPR、TCPA 等）合规性的认证。Oracle 扫描及任何报告均为信息性的自动启发式分析。承包方并非律师事务所、持牌审计机构或监管机关。客户对其法律合规承担唯一责任，并应咨询合格的专业人士。",
          },
          {
