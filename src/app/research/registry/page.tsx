...
const МЕТА: Record<string, { title: string; desc: string }> = {
  ru: {
    ...
    desc:
      'Открытые данные: из 11 663 доменов федерального реестра CISA в нашем журнале у 1 361 (11,7 %) нет записи в DNS — имени не существует. Срез на 8 сентября 2026, проверка двумя независимыми резолверами, метод и ограничения раскрыты.',
  },
  en: {
