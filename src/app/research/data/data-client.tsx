  ...
  return (
    <main style={{ minHeight: '100vh', background: '#05070d', color: '#e2e8f0', padding: '96px 24px 60px' }}>
      <article style={{ maxWidth: 900, margin: '0 auto' }}>
        ...
        <div style={{ overflowX: 'auto', marginBottom: 24 }} tabIndex={0}>
        ...
        <div style={{ overflowX: 'auto', marginBottom: 20 }} tabIndex={0}>
        ...
        */}
        ...
        <div style={{ overflowX: 'auto', marginBottom: 16 }} tabIndex={0}>
        ...
        <h3 style={{ ...ЗАГ2, fontSize: 20, marginTop: 28 }}>{т.перепрЗаголовок}</h3>
        <p style={ТЕКСТ}>{т.перепрТекст1(Ф.перепрДоменов, Ф.перепрЖивых, Ф.перепрДоля, Ф.перепрЗаписей, Ф.перепрОтдают200)}</p>
        <p style={ТЕКСТ}>{т.перепрТекст2(Ф.перепрГородов, Ф.перепрСайтЕсть, Ф.перепрСайтЕстьДоля, Ф.перепрЗаглушка, Ф.перепрЗаглушкаДоля, Ф.перепрОтдаёт, Ф.перепрОтдаётДоля, Ф.перепрТишина, Ф.перепрТишинаДоля)}</p>
        <p style={ТЕКСТ}>{т.перепрПолный(Ф.перепрВсегоЗаписей, Ф.перепрВсегоДоменов, Ф.перепрПолнОтдаёт, Ф.перепрПолнОтдаётДоля, Ф.перепрПолнОтдаётДом, Ф.перепрПолнЗаглушка, Ф.перепрПолнЗаглушкаДоля, Ф.перепрПолнЗаглушкаДом, Ф.перепрПолнТишина, Ф.перепрПолнТишинаДоля, Ф.перепрПолнЕсть, Ф.перепрПолнЕстьДоля)}</p>
        <p style={ТЕКСТ}>{т.перепрВывод}</p>
        ...
        <p style={ТЕКСТ}>{т.вернойЧисло(Ч.снимковДоля, Ч.снимковФайлов, Ч.снимковВсего)}</p>
        ...
        */}
        ...
        {/*
          Найдено 15.09.2026 в собственном методе: служебная ссылка
          «пропустить навигацию» засчитывалась как достигнутая цель.
          Публикуем сами, с обоими числами — 74,6 % при прежнем правиле
          и 85,3 % при строгом. Поправка идёт против измеренных сайтов.
        */}
        <h3 style={{ ...ЗАГ2, fontSize: 20, marginTop: 28 }}>{т.скипЗаголовок}</h3>
        <p style={ТЕКСТ}>{т.скипТекст}</p>
        ...
        */}
        <p style={ТЕКСТ}>
          {т.ограничение8(Ч.доляДоменовМёртвых, Ч.доменовМёртвых,
            Ч.доменовРеестраDNS, Ч.записейУМёртвых,
                ...
                <tr key={в.дата + i}>
                  ...
                  <td style={{ ...ЯЧЕЙКА, color: '#cbd5e1', lineHeight: 1.55 }}>
                    ...
                    <div style={{ marginTop: 4, fontSize: 12,
                      ...
                      {/* Ссылка стоит рядом с пометкой намеренно: «опубликовано»
                          без возможности скачать — обещание без исполнения.
                          Адрес абсолютный: наборы лежат на aifa.works, у трёх
                          остальных сайтов своей папки данных нет. */}
                      {в.файл && (
                        <>
                          {' · '}
                          <a
                            href={`https://aifa.works/data/${в.файл}`}
