  ...
  return (
    <main style={ОБЁРТКА}>
      ...
      {/* КАК ПРОВЕРИТЬ, ЧТО ЧИСЛА НЕ ПОДОГНАНЫ.
          ...
          ведёт заинтересованная сторона. До 16.09.2026 ответа, проверяемого
          БЕЗ НАС, у нас не было; теперь есть, и его место рядом с данными.
          Раздел 20 Конституции соблюдён: ни токена, ни тарифов, ни призывов. */}
      <h2 style={ЗАГ2}>{т.заверениеЗаголовок}</h2>
