...
const JSON_LD = [
  ...
  },
  {
    ...
    url: "https://radiocode.space",
    description:
      "Eternal cyberpunk radio from the CODE Eternal ecosystem — 6 stations, 530 original songs in 1024 versions by AIfa & DJ Galatin.",
    inLanguage: "en",
...
export default async function RootLayout({
   ...
   * AIfaFocus выставил за это замечание GPC-002 — продавать аудит и не проходить
