...
export interface ComplianceCheck {
   ...
   *                 разметка, куки, TLS, содержимое страниц. Таких 1864 (26.09.2026).
   * `indicative`  — по внешним признакам можно лишь ПРЕДПОЛОЖИТЬ пробел в
   *                 организационном контроле; подтверждает только аудит.
   *                 Таких 136 (26.09.2026): прежние 73 — SOC2, SOC2P, ISO27,
   *                 NISTP, OPS, FIN — и 63 из замены шаблонов 26.09.2026
   *                 (DORA, NYDFS, GLBA, реестры брокеров данных, CSRD и др.:
   *                 регистрация, программы безопасности, внутренние процедуры).
   *
   ...
   * На 22.08.2026 было 1927 и 73; после замены шаблонов 26.09.2026 — 1864 и 136.
   *
