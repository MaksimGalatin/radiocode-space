...
export const threatMatrixRu: ComplianceCheck[] = [
  ...
  },
  {
    ...
    "description": "Отмена подписки требует больше шагов, телефонных звонков или препятствий, чем её оформление. Федеральный закон ROSCA требует простого способа прекратить регулярные списания, а Калифорния — онлайн-отмены прямой ссылкой или кнопкой для подписок, оформленных онлайн. Правило FTC «Click-to-Cancel» 2024 года отменено 8-м апелляционным округом 8 июля 2025 года.",
    "severity": "serious",
...
},
{
  ...
  },
  {
    ...
    "evidenceKind": "indicative",
    "category": "State Privacy Laws",
    "title": "Брокер данных не зарегистрирован в Техасе",
    "description": "Компания, которая собирает, обрабатывает или передаёт персональные данные, полученные не напрямую от людей, судя по признакам, работает в Техасе как брокер данных без регистрации у государственного секретаря штата (сбор $300). Штраф — не меньше $100 в день плюс неуплаченные сборы, до $10 000 за 12 месяцев. Подтверждается публичным реестром, а не сайтом.",
    "severity": "serious",
  ...
  },
  {
    ...
    "evidenceKind": "observable",
    "category": "State Privacy Laws",
    "title": "На сайте нет заметного уведомления о брокере данных (Техас)",
    "description": "Сайт или приложение брокера данных не размещает заметного уведомления о том, что компания — брокер данных: ясного, не вводящего в заблуждение, легко доступного для всех, включая людей с инвалидностью, и содержащего формулировку, утверждённую государственным секретарём Техаса. Штраф — не меньше $100 в день, до $10 000 за 12 месяцев.",
    "severity": "serious",
  ...
  },
  {
    ...
    "evidenceKind": "observable",
    "category": "State Privacy Laws",
    "title": "Уведомление брокера данных без инструкций по правам (Техас)",
    "description": "Уведомление брокера данных на сайте или в приложении не сообщает потребителям, как воспользоваться их правами по техасскому закону о конфиденциальности и безопасности данных (гл. 541), — требование действует с 1 сентября 2025 года.",
    "severity": "moderate",
  ...
  },
  {
    ...
    "evidenceKind": "indicative",
    "category": "State Privacy Laws",
    "title": "Нет комплексной программы информационной безопасности (брокер данных, Техас)",
    "description": "У брокера данных, работающего в Техасе, видны признаки слабой защиты данных (например, открытые наружу данные или отсутствие базовых мер), что указывает на отсутствие письменной комплексной программы информационной безопасности с административными, техническими и физическими мерами, которую Техас требует от брокеров данных. Подтверждается аудитом.",
    "severity": "serious",
  ...
  },
  {
    ...
    "evidenceKind": "indicative",
    "category": "State Privacy Laws",
    "title": "Брокер данных не зарегистрирован в Агентстве по защите конфиденциальности Калифорнии",
    "description": "Компания, подпадающая под определение брокера данных, судя по признакам, не зарегистрировалась в Калифорнийском агентстве по защите конфиденциальности до 31 января следующего года. Административный штраф — $200 за каждый день без регистрации плюс неуплаченные сборы и расходы. Подтверждается реестром агентства, а не сайтом.",
    "severity": "serious",
  ...
  },
  {
    ...
    "evidenceKind": "observable",
    "category": "State Privacy Laws",
    "title": "Политика конфиденциальности брокера данных без показателей запросов (Калифорния)",
    "description": "Политика конфиденциальности брокера данных не раскрывает к 1 июля каждого года, сколько запросов на удаление, доступ, отказ от продажи и связанных запросов потребителей он получил, выполнил и отклонил за прошлый год, с медианным и средним сроком ответа и причинами отказов.",
    "severity": "moderate",
  ...
  },
  {
    ...
    "evidenceKind": "indicative",
    "category": "State Privacy Laws",
    "title": "Брокер данных не обрабатывает запросы на удаление из калифорнийской системы DROP",
    "description": "С 1 августа 2026 года зарегистрированный брокер данных обязан не реже раза в 45 дней обращаться к единому механизму удаления Калифорнийского агентства по защите конфиденциальности и удалять данные людей, подавших запрос. Признаки вроде продолжающегося показа данных человека указывают, что этого не происходит. Штраф — $200 за каждый запрос на удаление за каждый день нарушения.",
    "severity": "serious",
  ...
  },
  {
    ...
    "evidenceKind": "indicative",
    "category": "State Privacy Laws",
    "title": "Брокер данных не зарегистрирован в Вермонте",
    "description": "Брокер данных, судя по признакам, не прошёл ежегодную регистрацию у государственного секретаря Вермонта до 31 января (сбор $100) с указанием способов отказа, видов деятельности, от которых отказаться нельзя, проверки покупателей данных и утечек за прошлый год. Подтверждается реестром штата, а не сайтом.",
    "severity": "moderate",
  ...
  },
  {
    ...
    "evidenceKind": "indicative",
    "category": "State Privacy Laws",
    "title": "Нет письменной программы информационной безопасности (брокер данных, Вермонт)",
    "description": "Признаки слабой защиты данных указывают, что у брокера данных нет письменной комплексной программы информационной безопасности, которую требует Вермонт, — с назначенным ответственным сотрудником и оценкой предсказуемых внутренних и внешних рисков для персональных данных. Подтверждается аудитом.",
    "severity": "serious",
  ...
  },
  {
    ...
    "evidenceKind": "observable",
    "category": "State Privacy Laws",
    "title": "Нет заметной страницы с инструкциями по правам (брокер данных, Техас)",
    "description": "На сайте брокера данных нет страницы, на которой заметно размещены конкретные инструкции, как потребитель может воспользоваться правами по техасскому закону о конфиденциальности и безопасности данных; с 1 сентября 2025 года ссылка на такую страницу обязательна в регистрации брокера у государственного секретаря.",
    "severity": "moderate",
  ...
  },
  {
    ...
    "evidenceKind": "indicative",
    "category": "HIPAA / Medical",
    "title": "Геозоны вокруг медицинских учреждений (Вашингтон)",
    "description": "Технологии отслеживания местоположения или рекламы на сайте указывают на геозону — виртуальную границу не дальше 2 000 футов — вокруг учреждения, оказывающего очную медицинскую помощь, чтобы выявлять или отслеживать людей, обращающихся за помощью, собирать их данные о здоровье или слать им сообщения и рекламу о здоровье. В Вашингтоне это незаконно; подтверждается аудитом кампаний по местоположению.",
    "severity": "critical",
  ...
  },
  {
    ...
    "evidenceKind": "observable",
    "category": "HIPAA / Medical",
    "title": "На главной нет ссылки на политику по данным о здоровье (Вашингтон)",
    "description": "Компания, собирающая данные о здоровье потребителей, не размещает на главной странице заметную ссылку на отдельную политику конфиденциальности данных о здоровье, как требует вашингтонский закон My Health My Data от регулируемых организаций и малого бизнеса.",
    "severity": "serious",
  ...
  },
  {
    ...
    "evidenceKind": "observable",
    "category": "HIPAA / Medical",
    "title": "В политике по данным о здоровье нет обязательных сведений (Вашингтон)",
    "description": "Политика конфиденциальности данных о здоровье не раскрывает ясно и заметно, какие категории данных о здоровье собираются и зачем, откуда они берутся, какие категории передаются, каким категориям третьих лиц и каким конкретно аффилированным компаниям, и как потребитель может воспользоваться своими правами.",
    "severity": "serious",
  ...
  },
  {
    ...
    "evidenceKind": "observable",
    "category": "HIPAA / Medical",
    "title": "Одно согласие и на сбор, и на передачу данных о здоровье (Вашингтон)",
    "description": "Сайт берёт одно согласие сразу на сбор и на передачу данных о здоровье, хотя Вашингтон требует на передачу отдельного согласия, независимого от согласия на сбор, — если передача не нужна для оказания услуги, которую человек сам запросил.",
    "severity": "serious",
  ...
  },
  {
    ...
    "evidenceKind": "observable",
    "category": "HIPAA / Medical",
    "title": "Запрос согласия на данные о здоровье без обязательных сведений (Вашингтон)",
    "description": "Запрос согласия на сбор или передачу данных о здоровье не сообщает ясно и заметно категории данных, цель и конкретные способы использования, категории получателей и то, как человек может отозвать согласие.",
    "severity": "moderate",
  ...
  },
  {
    ...
    "evidenceKind": "observable",
    "category": "HIPAA / Medical",
    "title": "Нет способа подать запрос о правах на данные о здоровье (Вашингтон)",
    "description": "Политика конфиденциальности данных о здоровье не описывает надёжного и защищённого способа подать запрос — узнать, получить доступ, удалить данные о здоровье или отозвать согласие, — соответствующего тому, как люди обычно взаимодействуют с компанией.",
    "severity": "moderate",
  ...
  },
  {
    ...
    "evidenceKind": "indicative",
    "category": "HIPAA / Medical",
    "title": "Продажа данных о здоровье без подписанного разрешения (Вашингтон)",
    "description": "Есть признаки продажи или предложения продажи данных о здоровье (например, сведения о продаже данных или передача сигналов о здоровье рекламным партнёрам) без действительного разрешения человека — простым языком, с подписью, отдельно от согласия на сбор и сроком не больше года. Подтверждается аудитом продаж данных.",
    "severity": "critical",
  ...
  },
  {
    ...
    "evidenceKind": "indicative",
    "category": "HIPAA / Medical",
    "title": "Слабая защита и доступ к данным о здоровье (Вашингтон)",
    "description": "Видимые слабости защиты указывают, что доступ к данным о здоровье не ограничен сотрудниками и обработчиками, которым он нужен, а административные, технические и физические меры не соответствуют разумному стандарту отрасли. Подтверждается аудитом.",
    "severity": "serious",
  ...
  },
  {
    ...
    "evidenceKind": "indicative",
    "category": "HIPAA / Medical",
    "title": "Геозоны у учреждений психического, репродуктивного или сексуального здоровья (Коннектикут)",
    "description": "Технологии отслеживания местоположения или рекламы указывают на геозону в пределах 1 750 футов от учреждения психического, репродуктивного или сексуального здоровья, чтобы выявлять, отслеживать людей, собирать их данные или слать им уведомления о данных об их здоровье. Запрещено в Коннектикуте; принуждает Генеральный прокурор. Подтверждается аудитом.",
    "severity": "critical",
  ...
  },
  {
    ...
    "evidenceKind": "indicative",
    "category": "HIPAA / Medical",
    "title": "Продажа данных о здоровье без согласия (Коннектикут)",
    "description": "Есть признаки продажи или предложения продажи данных о здоровье — например, рекламодателям предлагаются аудитории по признакам здоровья — без предварительного согласия человека, что в Коннектикуте запрещено. Подтверждается аудитом продаж данных.",
    "severity": "critical",
  ...
  },
  {
    ...
    "evidenceKind": "indicative",
    "category": "Financial / Corporate",
    "title": "Нет ежегодного подтверждения соответствия для NY DFS",
    "description": "Финансовая компания под надзором Департамента финансовых услуг Нью-Йорка не проявляет признаков ежегодной подачи до 15 апреля письменного подтверждения существенного соответствия Part 500 за прошлый год или письменного признания несоответствия с планом исправления. Подтверждается у регулятора, а не по сайту.",
    "severity": "serious",
  ...
  },
  {
    ...
    "evidenceKind": "observable",
    "category": "Financial / Corporate",
    "title": "Непубличная информация не шифруется при передаче (NY DFS)",
    "description": "Страницы или формы компании под надзором DFS, через которые проходит непубличная информация, отдаются по обычному HTTP, со смешанным содержимым или по устаревшему TLS, хотя Part 500 требует шифрования по отраслевым стандартам для непубличной информации, передаваемой по внешним сетям.",
    "severity": "serious",
  ...
  },
  {
    ...
    "evidenceKind": "indicative",
    "category": "Financial / Corporate",
    "title": "Нет многофакторной аутентификации при доступе к системам (NY DFS)",
    "description": "Открытые в интернет страницы входа компании под надзором DFS указывают на вход только по паролю, хотя Part 500 требует многофакторную аутентификацию для любого, кто входит в её информационные системы (для малых компаний с ограниченной льготой — как минимум для удалённого доступа, облачных приложений с непубличной информацией и привилегированных учётных записей). Подтверждается аудитом.",
    "severity": "serious",
  ...
  },
  {
    ...
    "evidenceKind": "indicative",
    "category": "Financial / Corporate",
    "title": "Нет ежегодного теста на проникновение (NY DFS)",
    "description": "Давние и легко обнаруживаемые слабости указывают, что компания не проводит не реже раза в год тест на проникновение в свои информационные системы изнутри и снаружи их границ силами квалифицированной стороны, как требует Part 500. Подтверждается аудитом.",
    "severity": "serious",
  ...
  },
  {
    ...
    "evidenceKind": "observable",
    "category": "Financial / Corporate",
    "title": "Известные уязвимости не устранены (NY DFS)",
    "description": "Публичный сайт компании под надзором DFS работает на ПО или библиотеках в версиях с публично известными уязвимостями, хотя Part 500 требует своевременно устранять уязвимости в порядке, зависящем от их риска.",
    "severity": "serious",
  ...
  },
  {
    ...
    "evidenceKind": "indicative",
    "category": "Financial / Corporate",
    "title": "Об инциденте кибербезопасности не сообщено в DFS за 72 часа",
    "description": "Есть публичные признаки инцидента кибербезопасности (например, подмена страниц, утечка данных или сообщение о вымогателе), но нет свидетельств, что компания уведомила суперинтенданта электронно в течение 72 часов после установления инцидента, как требует Part 500. Подтверждается у регулятора.",
    "severity": "serious",
  ...
  },
  {
    ...
    "evidenceKind": "indicative",
    "category": "Financial / Corporate",
    "title": "Нет полного реестра ИТ-активов (NY DFS)",
    "description": "Забытые поддомены, тестовые системы или устаревшие службы, видимые из интернета, указывают, что у компании нет полного, точного и документированного реестра информационных систем — с владельцем, местом, классификацией и сроком окончания поддержки, — которого требует Part 500. Подтверждается аудитом.",
    "severity": "moderate",
  ...
  },
  {
    ...
    "evidenceKind": "indicative",
    "category": "Financial / Corporate",
    "title": "Протоколы удалённого управления оставлены открытыми (NY DFS)",
    "description": "Службы удалённого управления устройствами компании (например, удалённый рабочий стол или VNC), судя по признакам, доступны из интернета, хотя Part 500 требует отключить или защищённо настроить все протоколы удалённого управления устройствами. Видно сканированием сети, а не по сайту; подтверждается аудитом.",
    "severity": "serious",
  ...
  },
  {
    ...
    "evidenceKind": "indicative",
    "category": "Financial / Corporate",
    "title": "Нет ежегодного обучения кибербезопасности (NY DFS)",
    "description": "Признаки уязвимости к социальной инженерии (например, опубликованные без мер защиты адреса и должности сотрудников или случаи фишинга) указывают, что компания не проводит не реже раза в год обучение кибербезопасности, включая социальную инженерию, для всего персонала, как требует Part 500. Подтверждается аудитом.",
    "severity": "moderate",
  ...
  },
  {
    ...
    "evidenceKind": "indicative",
    "category": "Financial / Corporate",
    "title": "Нет политики паролей по отраслевым стандартам (NY DFS)",
    "description": "Формы входа без признаков требований к паролю или защиты от распространённых паролей указывают, что у компании нет письменной политики паролей по отраслевым стандартам, которую Part 500 требует везде, где используются пароли. Подтверждается аудитом.",
    "severity": "moderate",
  ...
  },
  {
    ...
    "evidenceKind": "indicative",
    "category": "Financial / Corporate",
    "title": "Строгая аутентификация клиента (SCA) не соответствует требованиям",
    "description": "Поставщик платёжных услуг, судя по признакам, не применяет строгую аутентификацию клиента — два независимых элемента из знания, владения или биометрии — при входе в платёжный счёт онлайн или инициировании электронного платежа, либо не привязывает удалённые платежи динамически к сумме и получателю. Обязанность лежит на поставщике платёжных услуг; подтверждается тестовым платежом или аудитом.",
    "severity": "critical",
  ...
  },
  {
    ...
    "evidenceKind": "observable",
    "category": "Financial / Corporate",
    "title": "Надбавка за оплату потребительской картой (ЕС)",
    "description": "Оформление заказа добавляет плату за оплату потребительской дебетовой или кредитной картой, межбанковская комиссия по которой регулируется Регламентом (ЕС) 2015/751, или за переводы и прямые списания SEPA, хотя PSD2 запрещает получателю платежа требовать такую плату.",
    "severity": "serious",
  ...
  },
  {
    ...
    "evidenceKind": "observable",
    "category": "Financial / Corporate",
    "title": "Плата за способ оплаты выше расходов продавца (ЕС)",
    "description": "Сайт берёт с потребителя плату за определённый способ оплаты (например, электронный кошелёк или корпоративную карту), которая, судя по размеру, превышает расходы продавца на этот способ, что потребительское право ЕС запрещает.",
    "severity": "moderate",
  ...
  },
  {
    ...
    "evidenceKind": "observable",
    "category": "Financial / Corporate",
    "title": "Конвертация валюты без раскрытия комиссий и курса (ЕС)",
    "description": "При оплате получатель предлагает списать сумму в другой валюте (динамическая конвертация) и не раскрывает заранее все комиссии и курс обмена, хотя PSD2 требует такого раскрытия и согласия плательщика на этих условиях.",
    "severity": "moderate",
  ...
  },
  {
    ...
    "evidenceKind": "observable",
    "category": "Financial / Corporate",
    "title": "Платёжная услуга без срока исполнения, комиссий или курса (ЕС)",
    "description": "Сайт поставщика платёжных услуг (например, сервиса денежных переводов) не сообщает до разового платежа максимальный срок исполнения, все комиссии с разбивкой и фактический или справочный курс обмена, как требует PSD2.",
    "severity": "moderate",
  ...
  },
  {
    ...
    "evidenceKind": "indicative",
    "category": "Financial / Corporate",
    "title": "При подтверждении платежа не видны сумма и получатель (ЕС)",
    "description": "На шаге подтверждения удалённого платежа плательщику не показываются сумма и получатель, либо код подтверждения не привязан к ним, как требуют технические стандарты ЕС о динамической привязке. Подтверждается тестовым платежом.",
    "severity": "serious",
  ...
  },
  {
    ...
    "evidenceKind": "observable",
    "category": "Financial / Corporate",
    "title": "Платёжные учётные данные защищены недостаточно (ЕС)",
    "description": "Страница входа или оплаты поставщика платёжных услуг передаёт персональные учётные данные пользователей без надлежащей защиты — например, по обычному HTTP, со смешанным содержимым или на странице, загружающей непроверенные сторонние скрипты, — хотя PSD2 требует надлежащих мер для защиты их конфиденциальности и целостности.",
    "severity": "serious",
  ...
  },
  {
    ...
    "evidenceKind": "indicative",
    "category": "Financial / Corporate",
    "title": "Пользователи не уведомлены о крупном инциденте безопасности (ЕС)",
    "description": "Есть публичные признаки крупного операционного инцидента или инцидента безопасности у поставщика платёжных услуг, но нет свидетельств, что он без неоправданной задержки сообщил пользователям об инциденте и о мерах, которые они могут принять, если затронуты или могут быть затронуты их финансовые интересы, как требует PSD2. Подтверждается аудитом.",
    "severity": "serious",
  ...
  },
  {
    ...
    "evidenceKind": "observable",
    "category": "Financial / Corporate",
    "title": "Надбавка за оплату потребительской картой (Великобритания)",
    "description": "Оформление заказа берёт плату за оплату потребительской (не корпоративной) картой или платежами, подпадающими под регламент SEPA, хотя в Великобритании получатель платежа не вправе брать с плательщика какую-либо плату за эти способы оплаты.",
    "severity": "serious",
  ...
  },
  {
    ...
    "evidenceKind": "indicative",
    "category": "Financial / Corporate",
    "title": "Строгая аутентификация клиента не применяется (Великобритания)",
    "description": "Британский поставщик платёжных услуг, судя по признакам, не применяет строгую аутентификацию клиента при входе в платёжный счёт онлайн, инициировании электронного платежа или действиях через удалённый канал с риском мошенничества, либо не привязывает удалённые платежи динамически к сумме и получателю. Подтверждается тестовым платежом или аудитом.",
    "severity": "critical",
  ...
  },
  {
    ...
    "evidenceKind": "observable",
    "category": "Financial / Corporate",
    "title": "Нет защищённой передачи финансовых данных",
    "description": "Страницы заявок или кабинета небанковской финансовой организации под юрисдикцией FTC (например, кредитора, ипотечного брокера или налогового консультанта) передают информацию о клиентах — номера социального страхования или кредитные сведения — по обычному HTTP, со смешанным содержимым или по устаревшему TLS, хотя Safeguards Rule требует шифровать всю информацию о клиентах при передаче по внешним сетям.",
    "severity": "serious",
  ...
  },
  {
    ...
    "evidenceKind": "indicative",
    "category": "Financial / Corporate",
    "title": "Нет многофакторной аутентификации при доступе к системам (GLBA)",
    "description": "Страницы входа не показывают признаков многофакторной аутентификации, хотя Safeguards Rule требует её для любого, кто входит в любую информационную систему, если ответственное лицо письменно не одобрило равноценные или более надёжные меры. Подтверждается аудитом.",
    "severity": "serious",
  ...
  },
  {
    ...
    "evidenceKind": "indicative",
    "category": "Financial / Corporate",
    "title": "Нет тестов на проникновение и полугодовых сканирований (GLBA)",
    "description": "Оставленные на месте публично известные уязвимости указывают, что при отсутствии непрерывного мониторинга организация не проводит ежегодные тесты на проникновение и оценку уязвимостей не реже раза в полгода, как Safeguards Rule требует от организаций с информацией о 5 000 и более потребителей. Подтверждается аудитом.",
    "severity": "serious",
  ...
  },
  {
    ...
    "evidenceKind": "observable",
    "category": "Financial / Corporate",
    "title": "Признаки небезопасной разработки клиентских приложений (GLBA)",
    "description": "Веб-приложения, которые передают или хранят информацию о клиентах, показывают признаки небезопасной разработки — например, открытые папки системы контроля версий, отладочные страницы, подробные сообщения об ошибках или листинги каталогов, — хотя Safeguards Rule требует безопасной разработки собственных приложений и проверки безопасности сторонних.",
    "severity": "serious",
  ...
  },
  {
    ...
    "evidenceKind": "indicative",
    "category": "Financial / Corporate",
    "title": "Утечка данных 500+ потребителей не сообщена в FTC за 30 дней",
    "description": "Есть публичные признаки события безопасности с незашифрованной информацией о клиентах, но нет свидетельств, что организация уведомила FTC электронно не позднее 30 дней после обнаружения, как требуется, если затронуто не меньше 500 потребителей. Подтверждается у регулятора.",
    "severity": "serious",
  ...
  },
  {
    ...
    "evidenceKind": "indicative",
    "category": "Financial / Corporate",
    "title": "Информация о клиентах хранится дольше двух лет без нужды (GLBA)",
    "description": "Признаки вроде заявлений о бессрочном хранении или давно неактивных учётных записей с полными данными указывают, что у организации нет порядка безопасного уничтожения информации о клиентах не позднее двух лет после последнего использования, если она не нужна и не обязательна по закону, и что политика хранения не пересматривается. Подтверждается аудитом.",
    "severity": "moderate",
  ...
  },
  {
    ...
    "evidenceKind": "indicative",
    "category": "Financial / Corporate",
    "title": "Нет ответственного лица за программу безопасности (GLBA)",
    "description": "Нет признаков назначенного ответственного лица (Qualified Individual), которое надзирает за программой информационной безопасности, внедряет её и обеспечивает её исполнение, — например, нет вообще никакого контакта по безопасности, — хотя Safeguards Rule его требует (он может работать у поставщика услуг или аффилированной компании). Подтверждается аудитом.",
    "severity": "moderate",
  ...
  },
  {
    ...
    "evidenceKind": "indicative",
    "category": "Financial / Corporate",
    "title": "Нет письменного плана реагирования на инциденты (GLBA)",
    "description": "Признаки медленной или неорганизованной реакции на событие безопасности указывают, что у организации нет письменного плана реагирования на инциденты — с целями, ролями, коммуникациями, устранением последствий и документированием, — который Safeguards Rule требует от организаций с информацией о 5 000 и более потребителей. Подтверждается аудитом.",
    "severity": "moderate",
  ...
  },
  {
    ...
    "evidenceKind": "indicative",
    "category": "Financial / Corporate",
    "title": "Нет обучения персонала основам безопасности (GLBA)",
    "description": "Признаки уязвимости к социальной инженерии указывают, что организация не проводит для персонала обучение основам безопасности, обновляемое под риски из её оценки рисков, как требует Safeguards Rule. Подтверждается аудитом.",
    "severity": "moderate",
  ...
  },
  {
    ...
    "evidenceKind": "indicative",
    "category": "Financial / Corporate",
    "title": "Поставщики услуг получают данные клиентов без надзора (GLBA)",
    "description": "Сторонние скрипты или сервисы получают данные со страниц заявок или кабинета, что указывает: организация не выбирает способных поставщиков, не обязывает их договором поддерживать меры защиты и периодически их не оценивает, как требует Safeguards Rule. Подтверждается аудитом договоров и оценок.",
    "severity": "moderate",
  ...
  },
  {
    ...
    "evidenceKind": "observable",
    "category": "FTC Enforcement",
    "title": "Скидки от фиктивной «прежней» цены",
    "description": "Каталог показывает зачёркнутые «прежние» цены как основу скидки, но нет признаков, что товар действительно открыто и добросовестно продавался по этой цене на регулярной основе достаточно долгое время, — например, «распродажа» идёт постоянно или цены «было» никогда не взимались. Руководство FTC считает фиктивную прежнюю цену ложной выгодой.",
    "severity": "serious",
  ...
  },
  {
    ...
    "evidenceKind": "observable",
    "category": "FTC Enforcement",
    "title": "Сравнение с «ценой в других магазинах» без оснований",
    "description": "На страницах товара указана цена «сравните с» или «стоимость», из которой следует, что другие продавцы продают тот же товар по этой цене, но нет подтверждения, что по ней действительно идут заметные продажи в этом регионе.",
    "severity": "serious",
  ...
  },
  {
    ...
    "evidenceKind": "observable",
    "category": "FTC Enforcement",
    "title": "Рекомендованная цена производителя как фиктивная точка отсчёта",
    "description": "Скидки считаются от прейскурантной или рекомендованной цены производителя, по которой на рынке в действительности заметных продаж нет.",
    "severity": "serious",
  ...
  },
  {
    ...
    "evidenceKind": "observable",
    "category": "FTC Enforcement",
    "title": "Завышенная цена основного товара в акциях «бесплатно» и «1+1»",
    "description": "Предложение «бесплатно» или «второй в подарок» требует покупки другого товара, цену которого подняли или качество либо количество которого уменьшили, чтобы покрыть стоимость «бесплатного».",
    "severity": "serious",
  ...
  },
  {
    ...
    "evidenceKind": "observable",
    "category": "FTC Enforcement",
    "title": "Ложные «оптовые», «заводские» и «ограниченные» цены",
    "description": "Сайт называет розничные цены «оптовыми» или «заводскими», рекламирует «ограниченные» предложения, которые на деле не ограничены, или продаёт уценённый и некондиционный товар со скидкой от цены целого, не сообщая об этом.",
    "severity": "moderate",
  ...
  },
  {
    ...
    "evidenceKind": "observable",
    "category": "FTC Enforcement",
    "title": "Скрытые обязательные сборы в билетах на мероприятия и краткосрочном жилье",
    "description": "Сайт продажи билетов или краткосрочного жилья показывает цену без обязательных сборов либо показывает итоговую цену менее заметно, чем прочие цены. Правило FTC действует только для билетов на живые мероприятия и краткосрочного жилья.",
    "severity": "serious",
  ...
  },
  {
    ...
    "evidenceKind": "observable",
    "category": "FTC Enforcement",
    "title": "Искажение сути сервисных, бронировочных и курортных сборов",
    "description": "Сайт продажи билетов или жилья искажает суть, назначение, размер или возвратность сбора либо то, за что он берётся, — например, «сервисный сбор» подаётся как государственный налог.",
    "severity": "serious",
  ...
  },
  {
    ...
    "evidenceKind": "observable",
    "category": "Digital Operations",
    "title": "Скидка для покупателей из ЕС без «прежней цены» за 30 дней",
    "description": "Объявленная для покупателей из ЕС скидка не показывает прежнюю цену — самую низкую цену продавца за не менее чем 30 дней до снижения.",
    "severity": "serious",
  ...
  },
  {
    ...
    "evidenceKind": "observable",
    "category": "FTC Enforcement",
    "title": "Калифорния: «прежняя цена» старше трёх месяцев",
    "description": "Показанная покупателям из Калифорнии «прежняя» цена не была рыночной в течение трёх месяцев до публикации объявления, а дата, когда она действовала, чётко не указана.",
    "severity": "moderate",
  ...
  },
  {
    ...
    "evidenceKind": "observable",
    "category": "FTC Enforcement",
    "title": "Калифорния: обязательные сборы не включены в показанную цену",
    "description": "Цена, показанная покупателям из Калифорнии, не включает всех обязательных сборов; не включать можно только государственные налоги и фактическую стоимость доставки.",
    "severity": "serious",
  ...
  },
  {
    ...
    "evidenceKind": "observable",
    "category": "FTC Enforcement",
    "title": "Подписку, оформленную онлайн, нельзя отменить онлайн",
    "description": "Сайт позволяет оформить автоматически продлеваемую подписку онлайн, но не даёт отменить её онлайн — например, требует звонка или переписки со службой поддержки. Закон Калифорнии требует отмены онлайн в любой момент и без шагов, которые мешают или затягивают её: через заметную прямую ссылку или кнопку (в личном кабинете или настройках) либо через готовое письмо об отмене, которое даёт сама компания.",
    "severity": "serious",
  ...
  },
  {
    ...
    "evidenceKind": "observable",
    "category": "FTC Enforcement",
    "title": "Существенные условия не раскрыты до запроса платёжных данных",
    "description": "Онлайн-предложение с «негативной опцией» (списания продолжаются, пока человек не откажется) запрашивает данные карты или оплаты раньше, чем ясно и заметно раскрыты все существенные условия сделки — например, цена, периодичность списаний и то, что они повторяются до отмены.",
    "severity": "serious",
  ...
  },
  {
    ...
    "evidenceKind": "observable",
    "category": "FTC Enforcement",
    "title": "Регулярные списания без явного информированного согласия",
    "description": "Человека подписывают на регулярные списания без отдельного явного действия с его стороны — например, через заранее отмеченную галочку или просто самим оформлением покупки, — и продавец не получает явного информированного согласия, которого ROSCA требует до списания с карты или счёта.",
    "severity": "serious",
  ...
  },
  {
    ...
    "evidenceKind": "observable",
    "category": "FTC Enforcement",
    "title": "Условия автопродления не показаны рядом с запросом согласия",
    "description": "Условия автоматического продления не представлены ясно и заметно до завершения покупки и в зрительной близости к запросу согласия; если предложение включает бесплатный пробный период, не объяснено понятно, какая цена будет списываться после его окончания.",
    "severity": "serious",
  ...
  },
  {
    ...
    "evidenceKind": "observable",
    "category": "FTC Enforcement",
    "title": "Текст договора подрывает согласие на автопродление",
    "description": "Предложение или договор содержит сведения, которые мешают, отвлекают, противоречат или иным образом подрывают возможность человека дать явное согласие на автоматическое продление, — например, текст рядом с отметкой согласия, преуменьшающий условия продления или противоречащий им.",
    "severity": "moderate",
  ...
  },
  {
    ...
    "evidenceKind": "observable",
    "category": "FTC Enforcement",
    "title": "Удерживающее предложение без видимой кнопки «click to cancel»",
    "description": "Когда человек запрашивает отмену онлайн, сайт показывает скидку, бонус за то, чтобы остаться, или сведения о последствиях отмены и при этом не показывает одновременно заметную, постоянно видимую рядом прямую ссылку или кнопку с надписью «click to cancel» («отменить») или равнозначной.",
    "severity": "moderate",
  ...
  },
  {
    ...
    "evidenceKind": "observable",
    "category": "Digital Operations",
    "title": "Нет кнопки отмены «Verträge hier kündigen» (Германия)",
    "description": "На сайте, где потребитель может заключить платный длящийся договор, нет кнопки отмены с надписью только «Verträge hier kündigen» («расторгнуть договоры здесь») или столь же однозначной — постоянно доступной, прямо и легко достижимой и ведущей прямо на страницу подтверждения. Без такой кнопки потребитель вправе расторгнуть договор в любой момент без срока уведомления (§ 312k(6) BGB).",
    "severity": "serious",
  ...
  },
  {
    ...
    "evidenceKind": "observable",
    "category": "Digital Operations",
    "title": "Неполная страница подтверждения отмены (Германия)",
    "description": "Кнопка отмены ведёт на страницу, которая не предлагает и не позволяет указать вид расторжения (а при чрезвычайном расторжении — его причину), данные для однозначной идентификации человека, сам договор, момент, когда расторжение должно вступить в силу, и способ получить электронное подтверждение, либо на ней нет кнопки подтверждения с надписью только «jetzt kündigen» («расторгнуть сейчас») или столь же однозначной.",
    "severity": "moderate",
  ...
  },
  {
    ...
    "evidenceKind": "observable",
    "category": "FTC Enforcement",
    "title": "Отменить сложнее, чем подписаться (Нью-Йорк)",
    "description": "Потребитель в Нью-Йорке не может отменить подписку в любой момент простым способом, таким же удобным, как тот, которым он дал согласие, и через тот же канал, либо отмене препятствуют или необоснованно её затягивают — например, дают ложные сведения о том, как отменить, или искажают последствия и стоимость отмены.",
    "severity": "serious",
  ...
  },
  {
    ...
    "evidenceKind": "observable",
    "category": "Digital Operations",
    "title": "Нет функции «отказаться от договора здесь» (ЕС)",
    "description": "Для дистанционных договоров, заключаемых через онлайн-интерфейс, на сайте нет функции отказа с надписью «withdraw from contract here» («отказаться от договора здесь») или однозначной равнозначной — заметно размещённой, доступной весь срок отказа и ведущей к онлайн-заявлению об отказе и шагу «confirm withdrawal» («подтвердить отказ»). Действует в ЕС с 19 июня 2026 года (статья внесена Директивой (ЕС) 2023/2673).",
    "severity": "serious",
  ...
  },
  {
    ...
    "evidenceKind": "observable",
    "category": "FTC Enforcement",
    "title": "Нераскрытое вознаграждение за отзывы",
    "description": "Отзывы или рекомендации на сайте написаны людьми, получившими от продавца деньги, бесплатный или удешевлённый товар, шанс выиграть приз или иную выгоду, и эта существенная связь не раскрыта ясно и заметно рядом с отзывом.",
    "severity": "serious",
  ...
  },
  {
    ...
    "evidenceKind": "observable",
    "category": "FTC Enforcement",
    "title": "Вознаграждение только за положительные отзывы",
    "description": "Сайт предлагает деньги, скидки, купоны, подарки, участие в розыгрыше или иные поощрения за отзывы определённой тональности — например, скидку за отзыв на пять звёзд. Правило FTC об отзывах и рекомендациях запрещает поощрение, зависящее от тональности отзыва, — положительной или отрицательной.",
    "severity": "serious",
  ...
  },
  {
    ...
    "evidenceKind": "observable",
    "category": "FTC Enforcement",
    "title": "Подконтрольный компании сайт выдаётся за независимые обзоры",
    "description": "Сайт обзоров или сравнений, страница «наград» или организация, которые компания контролирует, которыми владеет или управляет, подаются как источник независимых обзоров или мнений о категории товаров или услуг, куда входят её собственные.",
    "severity": "serious",
  ...
  },
  {
    ...
    "evidenceKind": "observable",
    "category": "FTC Enforcement",
    "title": "Отзывы об исключительных результатах без типичных результатов",
    "description": "Отзывы описывают результаты по ключевому свойству товара — например, сброшенный вес, заработок или экономию — без ясного и заметного указания, чего обычно может ожидать потребитель; Руководство FTC по рекомендациям требует такого указания, если рекламодатель не может подтвердить, что такие результаты типичны.",
    "severity": "moderate",
  ...
  },
  {
    ...
    "evidenceKind": "observable",
    "category": "FTC Enforcement",
    "title": "Условия сервиса запрещают отзывы или наказывают за них",
    "description": "Типовые условия продажи или обслуживания на сайте запрещают или ограничивают отзывы клиентов, вводят плату или штраф за отзыв либо требуют передать права интеллектуальной собственности на отзыв. По федеральному закону Consumer Review Fairness Act такие условия ничтожны, а их предложение незаконно; Калифорния отдельно запрещает условия договора, лишающие потребителя права высказываться о продавце или его товарах (штраф до $2 500, затем до $5 000).",
    "severity": "serious",
  ...
  },
  {
    ...
    "evidenceKind": "observable",
    "category": "Digital Operations",
    "title": "Не сказано, как проверяются отзывы (ЕС)",
    "description": "Сайт показывает отзывы потребителей о своих товарах, но не сообщает, обеспечивает ли он и как, что опубликованные отзывы оставлены людьми, которые действительно пользовались товаром или купили его. Право ЕС считает эти сведения существенными, и их отсутствие может быть введением в заблуждение путём умолчания.",
    "severity": "moderate",
  ...
  },
  {
    ...
    "evidenceKind": "observable",
    "category": "Digital Operations",
    "title": "«Проверенные отзывы» без настоящей проверки (ЕС)",
    "description": "Сайт утверждает, что отзывы оставлены людьми, которые действительно пользовались товаром или купили его, — например, меткой «проверенный покупатель», — хотя отзыв можно оставить без проверки покупки или использования, скажем, через открытую форму. Такое утверждение без разумных и соразмерных мер проверки входит в перечень ЕС практик, запрещённых при любых обстоятельствах.",
    "severity": "serious",
  ...
  },
  {
    ...
    "evidenceKind": "observable",
    "category": "Digital Operations",
    "title": "Отзывы публикуются вводящим в заблуждение образом (Великобритания)",
    "description": "Отзывы потребителей или сведения из них, например средняя оценка в звёздах, публикуются вводящим в заблуждение образом: отрицательные отзывы не публикуются или снимаются, а положительные показываются, положительным отдаётся больше места, или умалчивается, что автору заказали отзыв. В Великобритании запрещено при любых обстоятельствах с 6 апреля 2025 года.",
    "severity": "serious",
  ...
  },
  {
    ...
    "evidenceKind": "observable",
    "category": "Digital Operations",
    "title": "Платформа без опубликованных правил отзывов или удаляет отзывы (Китай)",
    "description": "Платформа электронной торговли, работающая с потребителями в Китае, не публикует правила оценки (отзывов), не даёт потребителям способа оценить товары и услуги, продаваемые на платформе, или удаляет отзывы потребителей о них.",
    "severity": "moderate",
  ...
  },
  {
    ...
    "evidenceKind": "observable",
    "category": "Digital Operations",
    "title": "Заказные отзывы без указания на это (Великобритания)",
    "description": "Компания публикует или поручает другим оставить либо написать отзывы, скрывающие, что за них было поощрение: автору так или иначе заказали отзыв, и это не видно ни из самого отзыва, ни иначе. В Великобритании запрещено при любых обстоятельствах с 6 апреля 2025 года.",
    "severity": "serious",
  ...
  },
  {
    ...
    "evidenceKind": "indicative",
    "category": "Financial / Corporate",
    "title": "Нет еженедельного сканирования уязвимостей критичных систем",
    "description": "У финансовой организации, подпадающей под DORA, нет признаков автоматического сканирования уязвимостей не реже раза в неделю для ИКТ-активов, обеспечивающих критичные или важные функции, как требуют технические стандарты ЕС по управлению ИКТ-рисками. Внешняя проверка может лишь указать на пробел (например, давно не обновлённое ПО); подтверждает его аудит.",
    "severity": "serious",
  ...
  },
  {
    ...
    "evidenceKind": "observable",
    "category": "Financial / Corporate",
    "title": "Устаревшие сторонние библиотеки с известными уязвимостями",
    "description": "Публичный веб-интерфейс финансовой организации загружает сторонние или открытые библиотеки в версиях с публично известными уязвимостями. Технические стандарты ЕС по ИКТ-рискам требуют отслеживать сторонние библиотеки в сервисах, обеспечивающих критичные или важные функции, и в первую очередь ставить исправления найденных уязвимостей.",
    "severity": "serious",
  ...
  },
  {
    ...
    "evidenceKind": "observable",
    "category": "Financial / Corporate",
    "title": "Незашифрованные соединения через публичный интернет",
    "description": "Страницы или точки доступа веб-сервиса финансовой организации открываются по обычному HTTP без перенаправления на HTTPS, либо HTTPS-страницы подгружают ресурсы по HTTP (смешанное содержимое), хотя технические стандарты ЕС по ИКТ-рискам требуют шифровать сетевые соединения, проходящие через публичные сети.",
    "severity": "serious",
  ...
  },
  {
    ...
    "evidenceKind": "observable",
    "category": "Financial / Corporate",
    "title": "Сертификат TLS просрочен или не продлён вовремя",
    "description": "Сертификат TLS сайта финансовой организации истёк или истекает в ближайшие дни, а новый не установлен, хотя технические стандарты ЕС по ИКТ-рискам требуют своевременно продлевать сертификаты до окончания их срока.",
    "severity": "serious",
  ...
  },
  {
    ...
    "evidenceKind": "observable",
    "category": "Financial / Corporate",
    "title": "Всё ещё принимаются устаревшие протоколы шифрования",
    "description": "Сайт финансовой организации до сих пор принимает TLS 1.0 или TLS 1.1, официально выведенные из употребления документом RFC 8996 в 2021 году, хотя технические стандарты ЕС по ИКТ-рискам требуют обновлять криптографию с учётом развития криптоанализа.",
    "severity": "serious",
  ...
  },
  {
    ...
    "evidenceKind": "indicative",
    "category": "Financial / Corporate",
    "title": "Нет порядка раскрытия уязвимостей клиентам и публике",
    "description": "У финансовой организации не видно порядка ответственного раскрытия уязвимостей клиентам, контрагентам и публике — например, нет бюллетеней безопасности, — хотя технические стандарты ЕС по ИКТ-рискам его требуют. Отсутствие на сайте лишь указывает на пробел; подтверждает его аудит.",
    "severity": "moderate",
  ...
  },
  {
    ...
    "evidenceKind": "indicative",
    "category": "Financial / Corporate",
    "title": "Найденные уязвимости не учитываются и не отслеживаются",
    "description": "Видимые снаружи уязвимости сохраняются долгое время — это указывает, что найденные уязвимости ИКТ-систем не записываются и их устранение не отслеживается, как требуют технические стандарты ЕС по ИКТ-рискам. Подтверждается только аудитом журнала уязвимостей.",
    "severity": "moderate",
  ...
  },
  {
    ...
    "evidenceKind": "indicative",
    "category": "Financial / Corporate",
    "title": "Нет актуального реестра сертификатов",
    "description": "Видимые снаружи проблемы с сертификатами (просроченные, несоответствующие или забытые на поддоменах) указывают, что финансовая организация не ведёт актуальный реестр сертификатов и устройств их хранения для ИКТ-активов критичных или важных функций, как требуют технические стандарты ЕС по ИКТ-рискам. Подтверждается аудитом.",
    "severity": "moderate",
  ...
  },
  {
    ...
    "evidenceKind": "indicative",
    "category": "Financial / Corporate",
    "title": "Нет ежегодного пересмотра защиты сети",
    "description": "Открытые наружу административные интерфейсы или лишние доступные службы указывают, что финансовая организация не пересматривает архитектуру сети и её защиту раз в год для поиска возможных уязвимостей, как требуют технические стандарты ЕС по ИКТ-рискам. Подтверждается аудитом.",
    "severity": "serious",
  ...
  },
  {
    ...
    "evidenceKind": "indicative",
    "category": "Financial / Corporate",
    "title": "Нет плана кризисных коммуникаций при крупных ИКТ-инцидентах",
    "description": "У финансовой организации не видно порядка кризисных коммуникаций — например, нет публичной страницы статуса или канала уведомлений об инцидентах — для ответственного раскрытия крупных ИКТ-инцидентов и уязвимостей клиентам, контрагентам и публике, чего DORA требует в рамках управления ИКТ-рисками. Подтверждается аудитом.",
    "severity": "moderate",
  ...
  },
  {
    ...
    "evidenceKind": "observable",
    "category": "Financial / Corporate",
    "title": "На сайте нет сведений о торговом реестре",
    "description": "Сайт поставщика услуг, учреждённого в ЕС, не указывает легко, прямо и постоянно доступным образом торговый реестр, в котором он зарегистрирован, и регистрационный номер (или иной идентификатор в этом реестре).",
    "severity": "moderate",
  ...
  },
  {
    ...
    "evidenceKind": "observable",
    "category": "Financial / Corporate",
    "title": "Нет наименования, географического адреса или прямых контактов",
    "description": "Сайт не держит постоянно доступными наименование поставщика услуг, географический адрес, где он учреждён, или контакты — включая адрес электронной почты, — позволяющие быстро связаться с ним напрямую; одна лишь форма обратной связи или абонентский ящик этих сведений не дают.",
    "severity": "moderate",
  ...
  },
  {
    ...
    "evidenceKind": "observable",
    "category": "Financial / Corporate",
    "title": "Не указан номер плательщика НДС",
    "description": "Поставщик услуг, чья деятельность облагается НДС, не указывает на сайте свой идентификационный номер плательщика НДС легко, прямо и постоянно доступным образом.",
    "severity": "advisory",
  ...
  },
  {
    ...
    "evidenceKind": "observable",
    "category": "Financial / Corporate",
    "title": "Для лицензируемой деятельности не назван надзорный орган",
    "description": "Сайт предлагает деятельность, требующую разрешения, — например, лицензируемые финансовые, страховые или платёжные услуги, — но не приводит сведений о надзорном органе, который её контролирует.",
    "severity": "moderate",
  ...
  },
  {
    ...
    "evidenceKind": "observable",
    "category": "Financial / Corporate",
    "title": "Нет выходных данных (Impressum) или они спрятаны (Германия)",
    "description": "На сайте, оказывающем коммерческие цифровые услуги, как правило за плату, нет выходных данных (Impressum), легко узнаваемых, прямо доступных и постоянно доступных, — например, ссылки на Impressum нет вовсе, до неё можно дойти лишь через несколько переходов или она спрятана за скриптом.",
    "severity": "serious",
  ...
  },
  {
    ...
    "evidenceKind": "observable",
    "category": "Financial / Corporate",
    "title": "В Impressum нет правовой формы или представителя (Германия)",
    "description": "Выходные данные компании (юридического лица) содержат наименование и адрес, но не указывают правовую форму или лицо, уполномоченное её представлять, как требует § 5(1) п. 1 немецкого закона Digitale-Dienste-Gesetz (DDG).",
    "severity": "moderate",
  ...
  },
  {
    ...
    "evidenceKind": "observable",
    "category": "Financial / Corporate",
    "title": "Сайт британской компании без регистрационного номера и адреса офиса (Великобритания)",
    "description": "Сайт компании, зарегистрированной в Соединённом Королевстве, не раскрывает, в какой части Королевства она зарегистрирована, её регистрационный номер и адрес зарегистрированного офиса.",
    "severity": "moderate",
  ...
  },
  {
    ...
    "evidenceKind": "observable",
    "category": "Financial / Corporate",
    "title": "Цены без указания, включены ли налог и доставка (Великобритания)",
    "description": "Онлайн-сервис, упоминающий цены, не указывает их ясно и недвусмысленно и, в частности, не сообщает, включены ли в них налог и стоимость доставки.",
    "severity": "moderate",
  ...
  },
  {
    ...
    "evidenceKind": "observable",
    "category": "Financial / Corporate",
    "title": "На главной странице нет сведений о лицензии (Китай)",
    "description": "Оператор электронной торговли, работающий с потребителями в Китае, не показывает постоянно на видном месте главной страницы сведения о своём бизнес-свидетельстве и административных разрешениях на деятельность (или ссылку на них). Штраф до ¥10 000 по ст. 76(1).",
    "severity": "moderate",
  ...
  },
  {
    ...
    "evidenceKind": "observable",
    "category": "Financial / Corporate",
    "title": "Регулируемая профессия без обязательных профессиональных сведений",
    "description": "Сайт, предлагающий услуги регулируемой профессии (например, юристов, врачей, архитекторов или бухгалтеров), не называет профессиональную организацию, в которой зарегистрирован поставщик, профессиональное звание и государство, где оно присвоено, или применимые профессиональные правила и способ с ними ознакомиться.",
    "severity": "moderate",
  ...
  },
  {
    ...
    "evidenceKind": "observable",
    "category": "ADA / WCAG",
    "title": "Слишком маленькие кнопки и ссылки",
    "description": "Интерактивные цели — ссылки навигации, значки, кнопки — меньше 24 на 24 CSS-пикселя без отступа, равноценного элемента или других исключений, которые допускает WCAG 2.2 (ссылки внутри текста, размеры браузера или существенные размеры), поэтому людям с нарушением моторики трудно на них попасть.",
    "severity": "serious",
    "reference": "WCAG 2.2 SC 2.5.8"
  },
  {
    ...
    "evidenceKind": "observable",
    "category": "ADA / WCAG",
    "title": "Содержимое заблокировано в одной ориентации экрана",
    "description": "Сайт показывается или работает только в книжной либо только в альбомной ориентации, хотя это не обязательно по сути, — и люди с закреплённым в одном положении устройством не могут им пользоваться.",
    "severity": "moderate",
  ...
  },
  {
    ...
    "evidenceKind": "observable",
    "category": "ADA / WCAG",
    "title": "Поля личных данных без указания назначения (autocomplete)",
    "description": "Поля формы, в которых человек вводит свои данные (имя, почту, телефон, адрес), не сообщают программно своё назначение — например, атрибутом HTML autocomplete, — поэтому браузер и вспомогательные программы не могут их заполнить или подписать.",
    "severity": "moderate",
  ...
  },
  {
    ...
    "evidenceKind": "observable",
    "category": "ADA / WCAG",
    "title": "Низкий контраст кнопок, рамок полей и значков",
    "description": "Видимые границы элементов управления (рамки полей, кнопки, флажки) и значимые значки имеют контраст ниже 3:1 с соседними цветами.",
    "severity": "serious",
  ...
  },
  {
    ...
    "evidenceKind": "observable",
    "category": "ADA / WCAG",
    "title": "Всплывающие по наведению блоки нельзя закрыть или удержать",
    "description": "Подсказки, меню или всплывающие блоки, появляющиеся при наведении или фокусе, нельзя закрыть, не уводя указатель или фокус, они исчезают, когда указатель переходит на них, или пропадают раньше, чем человек дочитал.",
    "severity": "moderate",
  ...
  },
  {
    ...
    "evidenceKind": "observable",
    "category": "ADA / WCAG",
    "title": "Команды из одной клавиши, которые нельзя отключить",
    "description": "Сайт использует клавиатурные команды из одной буквы, цифры или знака, которые нельзя отключить, переназначить или ограничить моментом, когда в фокусе нужный элемент, — у людей, управляющих голосом, это вызывает случайные действия.",
    "severity": "moderate",
  ...
  },
  {
    ...
    "evidenceKind": "observable",
    "category": "ADA / WCAG",
    "title": "Скрыт индикатор клавиатурного фокуса",
    "description": "Ссылки, кнопки и поля формы не показывают видимого фокуса при переходе с клавиатуры — часто потому, что стили CSS убирают обводку, — и человек с клавиатурой не видит, где находится.",
    "severity": "serious",
  ...
  },
  {
    ...
    "evidenceKind": "observable",
    "category": "ADA / WCAG",
    "title": "Функции только через жесты несколькими пальцами или по траектории",
    "description": "Карусели, карты или ползунки работают только щипком, несколькими пальцами или жестом по траектории, без альтернативы одним касанием или кнопкой.",
    "severity": "moderate",
  ...
  },
  {
    ...
    "evidenceKind": "observable",
    "category": "ADA / WCAG",
    "title": "Действие срабатывает при нажатии, а не при отпускании",
    "description": "Кнопки и элементы выполняют действие в момент нажатия, а не отпускания, поэтому человек, нажавший по ошибке, не может отменить действие, сдвинув палец или указатель в сторону.",
    "severity": "moderate",
  ...
  },
  {
    ...
    "evidenceKind": "observable",
    "category": "ADA / WCAG",
    "title": "Видимая подпись не входит в доступное имя",
    "description": "Доступное имя кнопки или ссылки (например, из aria-label) не содержит её видимого текста, поэтому человек, управляющий голосом и называющий то, что видит, не может её нажать.",
    "severity": "serious",
  ...
  },
  {
    ...
    "evidenceKind": "observable",
    "category": "ADA / WCAG",
    "title": "Недоступные элементы оформления заказа в интернет-магазине",
    "description": "Функции идентификации, безопасности и оплаты интернет-магазина — вход, коды подтверждения, поля карты, кнопки оплаты — не являются воспринимаемыми, управляемыми, понятными и надёжными (например, поля без подписей, CAPTCHA без доступной альтернативы или клавиатурная ловушка в платёжном окне), хотя Европейский акт о доступности требует их доступности.",
    "severity": "critical",
  ...
  },
  {
    ...
    "evidenceKind": "observable",
    "category": "ADA / WCAG",
    "title": "Сведения о доступности товаров не доводятся до покупателя (ЕС)",
    "description": "Страницы товаров интернет-магазина не содержат сведений о доступности продаваемых товаров или услуг, хотя Европейский акт о доступности требует от электронной торговли предоставлять их, когда их даёт ответственный хозяйствующий субъект (например, производитель).",
    "severity": "moderate",
  ...
  },
  {
    ...
    "evidenceKind": "observable",
    "category": "ADA / WCAG",
    "title": "Сайт услуги не воспринимаем, не управляем, не понятен или не надёжен (ЕС)",
    "description": "Сайт или связанное с ним онлайн-приложение услуги, подпадающей под Европейский акт о доступности, имеет нарушения доступности (например, нет текстовых альтернатив, недостаточный контраст или элементы, недоступные с клавиатуры), хотя акт требует последовательной и надлежащей доступности сайтов и мобильных сервисов.",
    "severity": "serious",
  ...
  },
  {
    ...
    "evidenceKind": "observable",
    "category": "ADA / WCAG",
    "title": "Сведения об услуге мелким шрифтом, с низким контрастом или жёстким интервалом (ЕС)",
    "description": "Сведения о работе услуги даны шрифтом неподходящего размера или начертания, с недостаточным контрастом или с межбуквенным, межстрочным и межабзацным интервалом, который нельзя изменить, хотя Европейский акт о доступности требует этих качеств подачи.",
    "severity": "moderate",
  ...
  },
  {
    ...
    "evidenceKind": "observable",
    "category": "ADA / WCAG",
    "title": "Службы поддержки без сведений о доступности (ЕС)",
    "description": "Справочная служба, контакт-центр или техподдержка на сайте не дают сведений о доступности услуги и её совместимости со вспомогательными технологиями или доступны только по одному недоступному каналу (например, только по телефону), хотя Европейский акт о доступности требует этого там, где службы поддержки есть.",
    "severity": "moderate",
  ...
  },
  {
    ...
    "evidenceKind": "observable",
    "category": "ADA / WCAG",
    "title": "В условиях обслуживания нет сведений о доступности (ЕС)",
    "description": "Общие условия обслуживания (или равноценный документ) не содержат сведений о том, как услуга соответствует требованиям доступности, — общего описания услуги в доступных форматах, пояснений, нужных для понимания её работы, и описания того, как выполнены требования Приложения I.",
    "severity": "moderate",
  ...
  },
  {
    ...
    "evidenceKind": "observable",
    "category": "ADA / WCAG",
    "title": "Сведения потребительского банкинга слишком сложны (выше B2) (ЕС)",
    "description": "Сведения, которые даёт потребительский банковский сервис, написаны сложнее уровня B2 (выше среднего) Общеевропейских компетенций владения языком, хотя Европейский акт о доступности требует, чтобы они были понятны в пределах этого уровня.",
    "severity": "moderate",
  ...
  },
  {
    ...
    "evidenceKind": "observable",
    "category": "ADA / WCAG",
    "title": "Недоступные идентификация, подпись или платежи в онлайн-банке (ЕС)",
    "description": "Способы идентификации, электронная подпись, шаги безопасности или платёжные функции потребительского банковского сервиса не воспринимаемы, не управляемы, не понятны или не надёжны — например, экраны одноразовых кодов с ограничением времени и без доступной альтернативы, — хотя Европейский акт о доступности требует их доступности.",
    "severity": "serious",
  ...
  },
  {
    ...
    "evidenceKind": "observable",
    "category": "ADA / WCAG",
    "title": "Услуга в Германии предлагается без соблюдения требований доступности",
    "description": "Услуга, подпадающая под немецкий закон об усилении доступности (BFSG), например интернет-магазин или потребительский банкинг, предлагается, хотя не отвечает требованиям доступности, — например, сайт не проходит базовые проверки доступности. Предложение такой услуги — административное правонарушение со штрафом до €100 000 (BFSG § 37(1) Nr. 8, (2)).",
    "severity": "serious",
  ...
  },
  {
    ...
    "evidenceKind": "observable",
    "category": "ADA / WCAG",
    "title": "Сведения о доступности не опубликованы в доступной форме (Германия)",
    "description": "Сведения, требуемые Приложением 3 немецкого закона об усилении доступности (как услуга соответствует требованиям доступности), не подготовлены или не сделаны общедоступными в доступной форме — например, их нет или они опубликованы только картинкой либо сканированным PDF.",
    "severity": "moderate",
  ...
  },
  {
    ...
    "evidenceKind": "observable",
    "category": "ADA / WCAG",
    "title": "Нет канала обратной связи о доступности",
    "description": "Организация, предоставляющая товары, услуги или помещения в Онтарио, не имеет общедоступного порядка приёма и рассмотрения отзывов о том, как она обслуживает людей с инвалидностью, хотя Интегрированные стандарты доступности требуют такого порядка и лёгкого доступа публики к сведениям о нём.",
    "severity": "serious",
  ...
  },
  {
    ...
    "evidenceKind": "observable",
    "category": "ADA / WCAG",
    "title": "Сайт ниже уровня WCAG 2.0 AA (Онтарио)",
    "description": "Публичный сайт крупной организации (50 и более сотрудников в Онтарио) или назначенной организации публичного сектора не выполняет критерии WCAG 2.0 уровня AA, хотя с 1 января 2021 года все её сайты и веб-содержимое обязаны им соответствовать (кроме субтитров в реальном времени 1.2.4 и аудиоописания записей 1.2.5).",
    "severity": "serious",
  ...
  },
  {
    ...
    "evidenceKind": "observable",
    "category": "ADA / WCAG",
    "title": "Нет уведомления о доступных форматах (Онтарио)",
    "description": "Организация не сообщает публике, что людям с инвалидностью по запросу доступны доступные форматы и средства коммуникации, как требуют Интегрированные стандарты доступности.",
    "severity": "moderate",
  ...
  },
  {
    ...
    "evidenceKind": "observable",
    "category": "ADA / WCAG",
    "title": "Порядок обратной связи без уведомления о доступных форматах (Онтарио)",
    "description": "У организации есть порядок обратной связи, но она не сообщает публике, что для него доступны доступные форматы и средства коммуникации, хотя Онтарио требует и доступности порядка обратной связи, и такого уведомления.",
    "severity": "moderate",
  ...
  },
  {
    ...
    "evidenceKind": "observable",
    "category": "ADA / WCAG",
    "title": "Политики доступности не опубликованы (Онтарио)",
    "description": "Организация, не относящаяся к малым, не делает общедоступными документы о своих политиках доступности — включая заявление о намерении своевременно удовлетворять потребности людей с инвалидностью — или не предлагает их по запросу в доступном формате.",
    "severity": "moderate",
  ...
  },
  {
    ...
    "evidenceKind": "indicative",
    "category": "ADA / WCAG",
    "title": "Нет публичных уведомлений о временных перебоях доступных услуг (Онтарио)",
    "description": "На сайте не видно практики публичных уведомлений о временных перебоях в работе помещений или услуг, которыми обычно пользуются люди с инвалидностью (например, доступного входа или лифта), с причиной, ожидаемой продолжительностью и доступными альтернативами, как требуют стандарты обслуживания Онтарио. Подтверждается аудитом.",
    "severity": "moderate",
  ...
  },
  {
    ...
    "evidenceKind": "indicative",
    "category": "ADA / WCAG",
    "title": "Доступные форматы выдаются не вовремя или за доплату (Онтарио)",
    "description": "Есть признаки, что доступные форматы и средства коммуникации не предоставляются по запросу своевременно и по цене не выше обычной, — например, доплата за крупный шрифт или долгие задержки, — хотя Онтарио этого требует. Подтверждается запросом или аудитом.",
    "severity": "moderate",
  ...
  },
  {
    ...
    "evidenceKind": "observable",
    "category": "ADA / WCAG",
    "title": "Порядок обратной связи без действий по жалобам (Онтарио)",
    "description": "Опубликованный порядок обратной связи не указывает, какие действия организация предпримет, получив жалобу на то, как она предоставляет товары, услуги или помещения людям с инвалидностью, как требует Онтарио.",
    "severity": "moderate",
  ...
  },
  {
    ...
    "evidenceKind": "indicative",
    "category": "ADA / WCAG",
    "title": "Документы по обслуживанию не предлагаются в доступных форматах (Онтарио)",
    "description": "Документы по обслуживанию, которые организация обязана выдавать по запросу (например, порядок обратной связи или правила о служебных животных), доступны, судя по признакам, только в недоступных файлах — это указывает, что по запросу они не предоставляются в доступном формате или со средствами коммуникации. Подтверждается запросом или аудитом.",
    "severity": "moderate",
  ...
  },
  {
    ...
    "evidenceKind": "indicative",
    "category": "ADA / WCAG",
    "title": "Ложный или вводящий в заблуждение отчёт о доступности (Онтарио)",
    "description": "Публичные заявления о полном соответствии требованиям доступности, опровергаемые нарушениями доступности на самом сайте, указывают, что отчёт организации о доступности директору Онтарио может содержать ложные или вводящие в заблуждение сведения, — это правонарушение со штрафом до $50 000 в день, а для корпорации до $100 000 в день. Подтверждается проверкой поданного отчёта.",
    "severity": "serious",
  ...
  },
  {
    ...
    "evidenceKind": "observable",
    "category": "ADA / WCAG",
    "title": "Нет субтитров к записанному видео (Section 508)",
    "description": "Записанные видео со звуком на публичном сайте федерального ведомства США (например, обучающие или вводные ролики) не имеют синхронных субтитров, хотя Section 508 требует соответствия публичного электронного содержимого WCAG 2.0 уровней A и AA, включая субтитры к записанному звуку.",
    "severity": "serious",
  ...
  },
  {
    ...
    "evidenceKind": "observable",
    "category": "ADA / WCAG",
    "title": "Публичное федеральное содержимое ниже WCAG 2.0 AA (Section 508)",
    "description": "Публичное электронное содержимое федерального ведомства — веб-страницы, документы, формы — не выполняет критерии WCAG 2.0 уровней A или AA, хотя пересмотренные стандарты 508 требуют соответствия всего публичного электронного содержимого.",
    "severity": "serious",
  ...
  },
  {
    ...
    "evidenceKind": "observable",
    "category": "ADA / WCAG",
    "title": "Видеоплеер без управления субтитрами рядом с громкостью (Section 508)",
    "description": "Встроенный видеоплеер даёт регулировку громкости, но не даёт включить субтитры на том же уровне меню, что и громкость или выбор программы, как требуют технические требования Section 508 к программному обеспечению.",
    "severity": "moderate",
  ...
  },
  {
    ...
    "evidenceKind": "observable",
    "category": "ADA / WCAG",
    "title": "Видеоплеер без управления аудиоописанием (Section 508)",
    "description": "Видеоплеер с выбором программы не даёт включить аудиоописание на том же уровне меню, что и громкость или выбор программы, как требует Section 508.",
    "severity": "moderate",
  ...
  },
  {
    ...
    "evidenceKind": "observable",
    "category": "ADA / WCAG",
    "title": "Справочная документация недоступна (Section 508)",
    "description": "Электронная справочная документация — страницы помощи, ответы на вопросы, руководства, веб-самообслуживание — не соответствует WCAG 2.0 уровней A и AA, например руководства в виде сканированных PDF без текста, хотя Section 508 этого требует.",
    "severity": "moderate",
  ...
  },
  {
    ...
    "evidenceKind": "observable",
    "category": "ADA / WCAG",
    "title": "Службы поддержки без сведений о функциях доступности (Section 508)",
    "description": "Страницы справочной службы или поддержки не дают сведений о функциях доступности и совместимости ИКТ (например, как пользоваться с экранной читалкой или только с клавиатуры), хотя Section 508 требует включать их в службы поддержки.",
    "severity": "moderate",
  ...
  },
  {
    ...
    "evidenceKind": "observable",
    "category": "ADA / WCAG",
    "title": "Нет способа пользоваться без зрения (Section 508)",
    "description": "Функции доступны только визуально — например, содержимое, нарисованное на canvas, кнопки-картинки или карты без текстовой альтернативы, — и нет режима работы, не требующего зрения, как требуют функциональные критерии Section 508.",
    "severity": "serious",
  ...
  },
  {
    ...
    "evidenceKind": "observable",
    "category": "ADA / WCAG",
    "title": "Нет способа пользоваться без слуха (Section 508)",
    "description": "Сведения или управление зависят от звука — только звуковые инструкции, звуковые сигналы или подкасты без расшифровки — и нет режима работы, не требующего слуха, как требуют функциональные критерии Section 508.",
    "severity": "serious",
  ...
  },
  {
    ...
    "evidenceKind": "observable",
    "category": "ADA / WCAG",
    "title": "Записанное видео без аудиоописания (Section 508)",
    "description": "Записанные видео на публичном сайте федерального ведомства передают важную визуальную информацию, которая не озвучена ни в основной дорожке, ни в дорожке аудиоописания, хотя Section 508 требует соответствия WCAG 2.0 уровня AA, включая аудиоописание записанного видео.",
    "severity": "moderate",
  ...
  },
  {
    ...
    "evidenceKind": "observable",
    "category": "ADA / WCAG",
    "title": "Федеральная услуга не даёт равного доступа (Section 508)",
    "description": "Люди с инвалидностью, обращающиеся онлайн за сведениями или услугами к федеральному ведомству, не могут получить к ним доступ и пользоваться ими наравне с другими — например, форму заявления нельзя заполнить с экранной читалкой, — хотя Section 508 требует равного доступа, а при несоразмерной нагрузке — альтернативного способа.",
    "severity": "serious",
  ...
  },
  {
    ...
    "evidenceKind": "indicative",
    "category": "Digital Operations",
    "title": "Нет аудита предвзятости алгоритма найма",
    "description": "Работодатель или кадровое агентство, нанимающие в Нью-Йорке, используют автоматизированный инструмент для отбора кандидатов или сотрудников без аудита предвзятости, проведённого не ранее чем за год до его использования. Штраф до $500 за первое нарушение и $500–1 500 за каждое последующее; каждый день использования — отдельное нарушение. Подтверждается документом об аудите.",
    "severity": "serious",
  ...
  },
  {
    ...
    "evidenceKind": "observable",
    "category": "Digital Operations",
    "title": "Итоги аудита предвзятости не опубликованы на сайте (Нью-Йорк)",
    "description": "Работодатель или кадровое агентство, использующие в Нью-Йорке автоматизированный инструмент решений о найме, не опубликовали на своём сайте до его использования сводку итогов последнего аудита предвзятости и дату распространения проверенного инструмента.",
    "severity": "serious",
  ...
  },
  {
    ...
    "evidenceKind": "observable",
    "category": "Digital Operations",
    "title": "Нет уведомления об автоматическом отборе и альтернативе (Нью-Йорк)",
    "description": "Вакансии или процесс подачи заявки не сообщают кандидатам из Нью-Йорка не позднее чем за десять рабочих дней до использования, что их будет оценивать автоматизированный инструмент решений о найме, и не дают попросить альтернативный порядок отбора или приспособление. Каждое пропущенное уведомление — отдельное нарушение.",
    "severity": "serious",
  ...
  },
  {
    ...
    "evidenceKind": "observable",
    "category": "Digital Operations",
    "title": "Не сообщается, какие качества оценивает инструмент (Нью-Йорк)",
    "description": "Кандидатам или сотрудникам в Нью-Йорке не сообщают не позднее чем за десять рабочих дней до использования, какие квалификационные требования и характеристики автоматизированный инструмент решений о найме будет использовать для их оценки.",
    "severity": "moderate",
  ...
  },
  {
    ...
    "evidenceKind": "observable",
    "category": "Digital Operations",
    "title": "Не раскрыты вид данных, источник и сроки хранения для инструмента найма (Нью-Йорк)",
    "description": "Сайт не раскрывает, какие данные собираются для автоматизированного инструмента решений о найме, откуда они берутся и какова политика их хранения; если этого нет на сайте, сведения должны быть выданы в течение 30 дней после письменного запроса кандидата или сотрудника.",
    "severity": "moderate",
  ...
  },
  {
    ...
    "evidenceKind": "indicative",
    "category": "Digital Operations",
    "title": "Автоматический отбор отсеивает кандидатов с инвалидностью (ADA)",
    "description": "Автоматические тесты или критерии отбора в онлайн-найме (например, игры на время, анализ видео или голоса) могут отсеивать кандидатов с инвалидностью; по ADA это дискриминация, если критерии не связаны с работой и не обусловлены деловой необходимостью. Подтверждается анализом результатов отбора.",
    "severity": "serious",
  ...
  },
  {
    ...
    "evidenceKind": "observable",
    "category": "Digital Operations",
    "title": "В онлайн-оценке нельзя попросить приспособление (ADA)",
    "description": "Онлайн-заявка или автоматическая оценка не дают кандидату способа попросить разумное приспособление — например, дополнительное время или другой формат, — хотя по ADA отказ в разумном приспособлении квалифицированному кандидату с инвалидностью — дискриминация, если оно не создаёт чрезмерных трудностей.",
    "severity": "moderate",
  ...
  },
  {
    ...
    "evidenceKind": "indicative",
    "category": "Digital Operations",
    "title": "Автоматический отбор с возможным несоразмерным воздействием (Title VII)",
    "description": "Автоматизированный инструмент найма, который ранжирует или отсеивает кандидатов, может несоразмерно затрагивать людей по расе, цвету кожи, религии, полу или национальному происхождению; по Title VII это незаконная практика найма, если работодатель не докажет связь с работой и деловую необходимость и не отказывался от менее дискриминационной альтернативы. Подтверждается статистическим анализом.",
    "severity": "serious",
  ...
  },
  {
    ...
    "evidenceKind": "observable",
    "category": "Digital Operations",
    "title": "Уведомление для кандидатов молчит об автоматических решениях (ЕС)",
    "description": "Уведомление о конфиденциальности для кандидатов не сообщает, используется ли автоматизированное принятие решений, включая профилирование, и не даёт содержательных сведений о его логике, значении и ожидаемых последствиях для кандидата, как требует GDPR, если такие решения принимаются.",
    "severity": "moderate",
  ...
  },
  {
    ...
    "evidenceKind": "indicative",
    "category": "Digital Operations",
    "title": "Кандидатам отказывают полностью автоматически без участия человека (ЕС)",
    "description": "Есть признаки, что заявки отклоняются автоматически — например, мгновенные письма с отказом после автоматического теста — без участия человека и без права добиться вмешательства человека, высказать свою позицию и оспорить решение, чего GDPR требует для решений, основанных только на автоматической обработке и имеющих юридические или сходные значимые последствия. Подтверждается аудитом.",
    "severity": "serious",
  ...
  },
  {
    ...
    "evidenceKind": "observable",
    "category": "State Privacy Laws",
    "title": "Нет согласия на биометрию при виртуальной примерке",
    "description": "Виртуальная примерка или похожая функция снимает геометрию лица (или другой биометрический идентификатор) в коммерческих целях, не сообщив об этом человеку заранее и не получив его согласия, что в Техасе запрещено; за каждое нарушение — гражданский штраф до $25 000.",
    "severity": "critical",
  ...
  },
  {
    ...
    "evidenceKind": "indicative",
    "category": "State Privacy Laws",
    "title": "Биометрические идентификаторы продаются или передаются другим (Техас)",
    "description": "Есть признаки, что снятые биометрические идентификаторы продаются, сдаются или передаются третьим лицам (например, данные лица уходят рекламному или аналитическому партнёру) вне узких исключений Техаса — таких как операция, запрошенная самим человеком, или ордер правоохранительных органов. До $25 000 за нарушение; подтверждается аудитом потоков данных.",
    "severity": "critical",
  ...
  },
  {
    ...
    "evidenceKind": "indicative",
    "category": "State Privacy Laws",
    "title": "Биометрия хранится после окончания цели (Техас)",
    "description": "Заявления или практика хранения указывают, что биометрические идентификаторы хранятся бессрочно, хотя Техас требует уничтожать их в разумный срок и не позднее года после того, как цель их сбора отпала. До $25 000 за нарушение; подтверждается аудитом.",
    "severity": "serious",
  ...
  },
  {
    ...
    "evidenceKind": "observable",
    "category": "State Privacy Laws",
    "title": "Биометрические изображения передаются без разумной осторожности (Техас)",
    "description": "Снимки лица или другие биометрические данные, которые снимает сайт, отправляются по незашифрованному соединению или уходят сторонним скриптам, хотя Техас требует хранить, передавать и защищать биометрические идентификаторы с разумной осторожностью, не хуже прочей конфиденциальной информации.",
    "severity": "serious",
  ...
  },
  {
    ...
    "evidenceKind": "observable",
    "category": "State Privacy Laws",
    "title": "Внесение биометрии в базу без уведомления, согласия или отказа (Вашингтон)",
    "description": "Сервис вносит биометрические идентификаторы (например, шаблоны лица или голоса) в базу данных в коммерческих целях, не дав заранее легкодоступного уведомления и не получив согласия либо не предоставив способа запретить их дальнейшее коммерческое использование, как требует Вашингтон. Принуждает Генеральный прокурор по закону о защите потребителей.",
    "severity": "serious",
  ...
  },
  {
    ...
    "evidenceKind": "indicative",
    "category": "State Privacy Laws",
    "title": "Внесённая в базу биометрия передаётся без согласия (Вашингтон)",
    "description": "Есть признаки, что внесённые в базу биометрические идентификаторы продаются, сдаются или передаются другим в коммерческих целях без согласия человека и вне исключений, которые допускает Вашингтон (например, запрошенная услуга, финансовая операция или судебный приказ). Подтверждается аудитом.",
    "severity": "serious",
  ...
  },
  {
    ...
    "evidenceKind": "indicative",
    "category": "State Privacy Laws",
    "title": "Внесённая биометрия хранится дольше необходимого (Вашингтон)",
    "description": "Заявления о хранении указывают, что внесённые в базу биометрические идентификаторы хранятся дольше, чем разумно нужно для оказания услуги, предотвращения мошенничества и угроз безопасности или исполнения закона и судебного приказа, как ограничивает Вашингтон. Подтверждается аудитом.",
    "severity": "moderate",
  ...
  },
  {
    ...
    "evidenceKind": "observable",
    "category": "State Privacy Laws",
    "title": "Биометрическая идентификация без явного согласия (ЕС)",
    "description": "Распознавание лица, голоса или похожие функции обрабатывают биометрические данные для однозначной идентификации людей в ЕС без явного согласия (или иного исключения из Art. 9(2)) — например, запускают сканирование лица без отдельного конкретного шага согласия.",
    "severity": "critical",
  ...
  },
  {
    ...
    "evidenceKind": "observable",
    "category": "State Privacy Laws",
    "title": "Нет простого способа отозвать согласие на биометрию (ЕС)",
    "description": "Согласие на обработку лица или голоса даётся одним нажатием, но так же легко отозвать его потом нельзя (например, только письмом или запросом по почте), хотя GDPR требует, чтобы отзыв был так же прост, как и дача согласия.",
    "severity": "moderate",
  ...
  },
  {
    ...
    "evidenceKind": "observable",
    "category": "State Privacy Laws",
    "title": "Поиск по лицу на снимках, собранных из интернета (Техас)",
    "description": "Сервис снимает биометрические идентификаторы с фотографий из интернета (например, поиск по лицу среди собранных снимков) и считает их общедоступность согласием, хотя в Техасе человек не считается уведомлённым и согласившимся только потому, что его снимок есть в сети, если он не опубликовал его сам. До $25 000 за нарушение.",
    "severity": "serious",
  ...
  },
  {
    ...
    "evidenceKind": "observable",
    "category": "State Privacy Laws",
    "title": "Сообщения чата читает третья сторона без предупреждения (Калифорния)",
    "description": "Сторонний скрипт чата или расшифровки получает сообщения посетителей в реальном времени, пока они отправляются, без уведомления и согласия всех сторон. Калифорнийская норма о прослушке запрещает читать или узнавать содержание сообщения в пути без согласия всех сторон и помогать в этом кому-либо; человек вправе требовать $5 000 за нарушение. Подпадают ли под неё поставщики чатов на сайтах — спорится в судах.",
    "severity": "critical",
  ...
  },
  {
    ...
    "evidenceKind": "observable",
    "category": "State Privacy Laws",
    "title": "Трекер записывает адресные данные без согласия (Калифорния)",
    "description": "Сторонние скрипты отслеживания снимают IP-адреса посетителей, идентификаторы устройств или иные адресные и маршрутные сведения без согласия. Калифорния запрещает устанавливать или использовать pen register или trap and trace — устройство или процесс, записывающий такие сведения, — без судебного приказа, и человек вправе требовать $5 000 за нарушение; подпадают ли под это трекеры сайтов — спорится в судах.",
    "severity": "serious",
  ...
  },
  {
    ...
    "evidenceKind": "observable",
    "category": "State Privacy Laws",
    "title": "Запись сеанса с конфиденциальными сообщениями без согласия (Калифорния)",
    "description": "Скрипты записи сеансов фиксируют то, что посетители вводят в чаты или формы по конфиденциальным вопросам (например, о здоровье или финансах), без согласия всех сторон. Калифорния запрещает записывать конфиденциальное общение без согласия всех сторон; штраф до $2 500 за нарушение и частные иски на $5 000 за нарушение.",
    "severity": "serious",
  ...
  },
  {
    ...
    "evidenceKind": "indicative",
    "category": "State Privacy Laws",
    "title": "Звонки с мобильных записываются без согласия (Калифорния)",
    "description": "Функции звонка с сайта или колл-центра указывают, что звонки клиентов — в том числе с мобильных или беспроводных телефонов — записываются без предупреждения звонящих и согласия всех сторон, что Калифорния запрещает. Подтверждается тестовым звонком или аудитом.",
    "severity": "serious",
  ...
  },
  {
    ...
    "evidenceKind": "observable",
    "category": "State Privacy Laws",
    "title": "Электронные сообщения перехватываются без согласия всех сторон (Флорида)",
    "description": "Скрипты чата, записи сеансов или подобные перехватывают электронные сообщения посетителей без предварительного согласия всех сторон, которое Флорида требует для законности перехвата. Человек, чьё сообщение перехвачено, вправе взыскать фактический ущерб, но не меньше $100 в день или $1 000 — что больше. Являются ли такие инструменты «перехватом» — спорится в судах.",
    "severity": "serious",
  ...
  },
  {
    ...
    "evidenceKind": "indicative",
    "category": "State Privacy Laws",
    "title": "Содержание перехваченных сообщений раскрывается или используется (Флорида)",
    "description": "Есть признаки, что содержание перехваченных чатов или записанных сеансов раскрывается другим компаниям или используется (например, для рекламы), хотя компания знала или должна была знать, что оно получено незаконным перехватом, что Флорида запрещает. Подтверждается аудитом передачи данных.",
    "severity": "serious",
  ...
  },
  {
    ...
    "evidenceKind": "observable",
    "category": "State Privacy Laws",
    "title": "Частные сообщения перехватываются без согласия всех участников (Вашингтон)",
    "description": "Функции чата или обмена сообщениями перехватывают или записывают частное общение между людьми устройством или процессом, предназначенным для записи или передачи, не получив заранее согласия всех участников, что в Вашингтоне незаконно.",
    "severity": "serious",
  ...
  },
  {
    ...
    "evidenceKind": "observable",
    "category": "State Privacy Laws",
    "title": "Голосовые функции записывают частные разговоры без согласия (Вашингтон)",
    "description": "Голосовые помощники, голосовые заметки или функции с микрофоном записывают частные разговоры, не получив заранее согласия всех их участников, что Вашингтон запрещает.",
    "severity": "moderate",
  ...
  },
  {
    ...
    "evidenceKind": "observable",
    "category": "State Privacy Laws",
    "title": "Скрипты записи сеанса или чата обращаются к устройству до согласия (ЕС)",
    "description": "Скрипты записи сеансов, тепловых карт или стороннего чата сохраняют или читают идентификаторы на устройстве посетителя до получения согласия, хотя для всего, что не строго необходимо для запрошенной услуги, право ЕС требует предварительного согласия на основе ясной и полной информации.",
    "severity": "serious",
    "reference": "ePrivacy Directive Art. 5(3)"
  },
  {
    ...
    "evidenceKind": "indicative",
    "category": "State Privacy Laws",
    "title": "Содержание перехваченного чата используется в других целях (Калифорния)",
    "description": "Есть признаки, что сведения из чатов, прочитанных в пути, используются в других целях — например, для обучения моделей или таргетинга рекламы, — хотя калифорнийская норма о прослушке запрещает и использование, и попытку использования так полученной информации. Подтверждается аудитом использования данных поставщиком.",
    "severity": "serious",
  ...
  },
  {
    ...
    "evidenceKind": "observable",
    "category": "Financial / Corporate",
    "title": "Нет канала жалоб по цепочке поставок",
    "description": "Компания, подпадающая под немецкий закон о должной осмотрительности в цепочках поставок (от 1 000 работников в Германии), не даёт публично доступных и понятных сведений, как обратиться и воспользоваться её порядком жалоб о рисках для прав человека и окружающей среды в собственной деятельности или у прямых поставщиков. Отсутствие такого порядка — штраф до €800 000.",
    "severity": "moderate",
  ...
  },
  {
    ...
    "evidenceKind": "observable",
    "category": "Financial / Corporate",
    "title": "Регламент порядка жалоб не опубликован (Германия)",
    "description": "Компания не опубликовала в текстовой форме регламент порядка жалоб по цепочке поставок, хотя немецкий закон о должной осмотрительности в цепочках поставок требует, чтобы он был публично доступен.",
    "severity": "moderate",
  ...
  },
  {
    ...
    "evidenceKind": "observable",
    "category": "Financial / Corporate",
    "title": "Годовой отчёт о должной осмотрительности не опубликован на сайте (Германия)",
    "description": "Компания не опубликовала на своём сайте бесплатно и в течение четырёх месяцев после окончания финансового года годовой отчёт о выполнении обязанностей должной осмотрительности в цепочке поставок (выявленные риски, принятые меры, их оценка и выводы), который должен оставаться доступным семь лет. Штраф до €100 000.",
    "severity": "serious",
  ...
  },
  {
    ...
    "evidenceKind": "indicative",
    "category": "Financial / Corporate",
    "title": "Нет заявления о политике в области прав человека (Германия)",
    "description": "Нет признаков заявления руководства о стратегии компании в области прав человека — с описанием порядка должной осмотрительности, приоритетных рисков для прав человека и окружающей среды и ожиданий к сотрудникам и поставщикам, — которое немецкий закон о цепочках поставок требует после выявления риска. Подтверждается аудитом.",
    "severity": "moderate",
  ...
  },
  {
    ...
    "evidenceKind": "indicative",
    "category": "Financial / Corporate",
    "title": "Порядок жалоб не проверяется ежегодно (Германия)",
    "description": "Устаревший или неработающий канал жалоб (например, битая ссылка или адрес без ответа) указывает, что компания не проверяет действенность порядка жалоб не реже раза в год и при изменении рисков, как требует немецкий закон о цепочках поставок. Штраф до €500 000; подтверждается аудитом.",
    "severity": "moderate",
  ...
  },
  {
    ...
    "evidenceKind": "observable",
    "category": "Financial / Corporate",
    "title": "На главной нет ссылки на раскрытие о рабском труде в поставках (Калифорния)",
    "description": "Ритейлер или производитель, ведущий бизнес в Калифорнии с мировой выручкой больше $100 млн, не размещает на главной странице заметную и понятную ссылку на раскрытие своих мер по искоренению рабства и торговли людьми в прямой цепочке поставок (проверка, аудиты, сертификация, внутренняя ответственность и обучение).",
    "severity": "moderate",
  ...
  },
  {
    ...
    "evidenceKind": "observable",
    "category": "Financial / Corporate",
    "title": "Заявление о современном рабстве не связано с главной страницей (Великобритания)",
    "description": "Коммерческая организация с оборотом выше британского порога, имеющая сайт, не публикует на нём годовое заявление о рабстве и торговле людьми или не размещает ссылку на него на видном месте главной страницы.",
    "severity": "moderate",
  ...
  },
  {
    ...
    "evidenceKind": "observable",
    "category": "Financial / Corporate",
    "title": "Заявление о современном рабстве не одобрено или не подписано (Великобритания)",
    "description": "В опубликованном заявлении компании о рабстве и торговле людьми не видно одобрения совета директоров (или равноценного органа) и подписи директора, как требует британский Modern Slavery Act (для LLP и товариществ — указанными в законе членами или партнёрами).",
    "severity": "moderate",
  ...
  },
  {
    ...
    "evidenceKind": "observable",
    "category": "Financial / Corporate",
    "title": "Отчёт о принудительном труде не опубликован на видном месте сайта (Канада)",
    "description": "Организация, обязанная до 31 мая каждого года отчитываться перед министром о мерах против принудительного и детского труда в цепочках поставок, не делает отчёт публичным, в том числе на видном месте своего сайта. Нарушение — правонарушение со штрафом до $250 000.",
    "severity": "serious",
  ...
  },
  {
    ...
    "evidenceKind": "observable",
    "category": "Financial / Corporate",
    "title": "В отчёте о принудительном труде нет обязательных сведений (Канада)",
    "description": "Опубликованный отчёт не описывает структуру, деятельность и цепочки поставок организации, её политики и проверки в отношении принудительного и детского труда, рискованные участки бизнеса и поставок и принятые меры, как требует канадский закон о цепочках поставок.",
    "severity": "moderate",
  ...
  },
  {
    ...
    "evidenceKind": "indicative",
    "category": "Financial / Corporate",
    "title": "Отчёт о деятельности не в едином электронном формате (ЕС)",
    "description": "Организация, обязанная отчитываться об устойчивости в ЕС, публикует отчёт о деятельности только в PDF или на веб-странице, что указывает: он не подготовлен в едином электронном формате (XHTML по Делегированному регламенту (ЕС) 2019/815), которого требует Директива о бухгалтерской отчётности; разметка раздела устойчивости станет обязательной только после принятия правил разметки. Подтверждается по официальной подаче отчётности.",
    "severity": "moderate",
  ...
  },
  {
    ...
    "evidenceKind": "indicative",
    "category": "Financial / Corporate",
    "title": "Организация в сфере действия не отчитывается об устойчивости (ЕС)",
    "description": "Организация, по признакам превышающая и чистый оборот €450 млн, и среднюю численность 1 000 работников, публикует отчёт о деятельности без сведений об устойчивости — о своём влиянии на вопросы устойчивости и о том, как они влияют на её развитие, результаты и положение. Подтверждается данными о размере и официальным отчётом.",
    "severity": "serious",
  ...
  },
  {
    ...
    "evidenceKind": "observable",
    "category": "Financial / Corporate",
    "title": "Сведения об устойчивости не выделены в отдельный раздел (ЕС)",
    "description": "Опубликованный отчёт о деятельности организации в сфере действия разносит сведения об устойчивости по всему документу вместо чётко различимого отдельного раздела, которого требует Директива о бухгалтерской отчётности.",
    "severity": "moderate",
  ...
  },
  {
    ...
    "evidenceKind": "indicative",
    "category": "Financial / Corporate",
    "title": "Нет плана перехода к цели 1,5 °C (ЕС)",
    "description": "Раздел об устойчивости не описывает планы организации — включая меры и связанные финансовые и инвестиционные планы — по приведению бизнес-модели и стратегии в соответствие с переходом к устойчивой экономике, ограничением потепления 1,5 °C по Парижскому соглашению и климатической нейтральностью к 2050 году. Подтверждается проверкой официального отчёта.",
    "severity": "moderate",
  ...
  },
  {
    ...
    "evidenceKind": "indicative",
    "category": "Financial / Corporate",
    "title": "Нет сроковых целей по устойчивости и прогресса (ЕС)",
    "description": "Раздел об устойчивости не содержит целей со сроками — включая, где уместно, абсолютные цели сокращения выбросов парниковых газов как минимум на 2030 и 2050 годы, — хода их достижения и заявления о том, основаны ли экологические цели на убедительных научных данных. Подтверждается проверкой официального отчёта.",
    "severity": "moderate",
  ...
  },
  {
    ...
    "evidenceKind": "indicative",
    "category": "Financial / Corporate",
    "title": "Не описаны должная осмотрительность и неблагоприятные воздействия (ЕС)",
    "description": "Раздел об устойчивости не описывает порядок должной осмотрительности по вопросам устойчивости, основные фактические или возможные неблагоприятные воздействия, связанные с собственной деятельностью и цепочкой создания стоимости, и меры по их предотвращению, смягчению или устранению. Подтверждается проверкой официального отчёта.",
    "severity": "moderate",
  ...
  },
  {
    ...
    "evidenceKind": "indicative",
    "category": "Financial / Corporate",
    "title": "Группа в сфере действия не даёт консолидированной отчётности об устойчивости (ЕС)",
    "description": "Материнская компания группы, по признакам превышающей на консолидированной основе чистый оборот €450 млн и среднюю численность 1 000 работников, публикует консолидированный отчёт о деятельности без отдельного раздела о влиянии группы на вопросы устойчивости и о том, как они влияют на группу. Подтверждается данными группы и официальным отчётом.",
    "severity": "serious",
  ...
  },
  {
    ...
    "evidenceKind": "indicative",
    "category": "Financial / Corporate",
    "title": "Нет заключения с ограниченной уверенностью по отчётности об устойчивости (ЕС)",
    "description": "В опубликованном отчёте нет заключения обязательного аудитора, основанного на задании по ограниченной уверенности, о соответствии отчётности об устойчивости директиве и стандартам отчётности, включая раскрытия по ст. 8 Регламента о таксономии. Подтверждается проверкой аудиторского заключения.",
    "severity": "moderate",
  ...
  },
  {
    ...
    "evidenceKind": "indicative",
    "category": "Financial / Corporate",
    "title": "Отчёт о деятельности не опубликован в течение 12 месяцев (ЕС)",
    "description": "Утверждённая финансовая отчётность и отчёт о деятельности с заключением аудитора, по признакам, не опубликованы в течение 12 месяцев после отчётной даты — где применимо, в электронном формате, — как требует Директива о бухгалтерской отчётности. Подтверждается по торговому реестру.",
    "severity": "moderate",
  ...
  },
  {
    ...
    "evidenceKind": "indicative",
    "category": "Financial / Corporate",
    "title": "Не описаны основные риски, связанные с устойчивостью (ЕС)",
    "description": "Раздел об устойчивости не описывает основные риски организации, связанные с вопросами устойчивости, её основные зависимости от этих вопросов и то, как она управляет этими рисками. Подтверждается проверкой официального отчёта.",
    "severity": "moderate",
