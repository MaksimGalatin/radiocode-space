 ...
 * разбора 12.08.2026 (каждый ролик просмотрен и прослушан) выяснилось, что из
 * двадцати китайских годны десять, и негодные лежат ВПЕРЕМЕЖКУ с годными.
 * Уменьшить число до 10 нельзя — «первые десять» это 01–10, среди которых три
 * негодных. Перенумеровать файлы на раздаче нельзя — сломаются разосланные
 * ссылки. Список решает и то и другое: файлы не трогаем, показываем проверенные.
 *
 * ЧТО ИСКЛЮЧЕНО И ПОЧЕМУ:
 *   zh-05, zh-16 — брак: губы не совпадают со звуком; в zh-16 рот не двигается
 *                  во время речи вовсе;
 *   zh-10, zh-13, zh-18 — ОШИБКА В ИМЕНИ ПРОЕКТА в самой речи: «扣之女»
 *                  («дочь вычета»), «Coze女», «Code织女» («Ткачиха») вместо
 *                  «Code之女». Речь звучит чисто, ошибку видно только в
 *                  расшифровке — поэтому и разбирали дословно;
 *   zh-03, zh-06, zh-07, zh-09, zh-19 — сильные изъяны картинки: мерцание,
 *                  плавающие контуры, отсутствие мимики, походка «скольжением».
 *
 * Русские, английские и испанские ещё не разобраны — идут полным списком.
 * Ставить им отметку «проверено» до разбора я не буду.
 */
