...
const СЕКРЕТЫ: RegExp[] = [
  ...
  /(?<![A-Za-z0-9_-])sk-[A-Za-z0-9_-]*[A-Z][A-Za-z0-9_-]{15,}/,                     // ключ OpenAI/Anthropic (в т.ч. sk-proj-, sk-ant-).
  // Заглавная буква в хвосте обязательна: без неё образец ловил название
  // голоса `sk-sk-x-multi-seanet-…` из настроек озвучки.
