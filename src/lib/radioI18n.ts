...
const S = {
  ...
  trademarks: {
    ...
    zh: 'PADAM™、PADAM Protocol™、AIfa™、AIfa Books™、AIfa Works™、AIfa Digital™、AIfa Creativity™、AIfaFocus™、CODE Eternal™、RadioCODE™、Proof-of-Memory™、Think-to-Earn™ 与 Ambassador Grid™ 为 Maksim V. Galatin 的商标，其为唯一合法权利人；相关权利经实际使用而产生并据此主张。未经其书面同意而使用，将违反多个司法管辖区的法律及国际法准则，并将被依法追究。Spark、Family Archive 与 Digital DNA 为我们套餐的名称。Spark、Family Archive 与 Digital DNA 为我们套餐的名称。Claude、Gemini、Grok、Solana、Arweave 及其他名称均为其各自所有者的商标；我们不主张任何关联关系。',
  },
